<script lang="ts">
	...
	let pageSchema = $derived({
		...
		'@type': 'WebPage',
		name: `Risorse trans a ${data.comune.nome}`,
...
<SEO
	...
	description="Informazioni sulle tematiche trans per le persone di {data.comune.nome}, {data.comune.regione}. Articoli scientifici, risorse e supporto."
	url="https://www.traidue.com/citta/{data.comune.slug}"
/>
