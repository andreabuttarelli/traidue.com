...
<div class="max-w-[720px] mx-auto px-4 py-12">
	...
	<header class="mb-12">
		...
		<p class="text-lg text-muted leading-relaxed">
			<strong>Tra i Due</strong> nasce con l'obiettivo di offrire informazione chiara, accessibile e
	...
	<section class="mb-12">
		...
		<div class="space-y-4 text-text leading-relaxed">
			<p>
				Per domande, suggerimenti o collaborazioni, puoi scriverci all'indirizzo:
			</p>
			<p>
				<a
					href="mailto:info@traidue.com"
