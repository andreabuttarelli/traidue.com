---
lang: "it"
translationKey: "religioni-e-persone-trans"
...
sources:
  - title: "Vatican – Dignitas Infinita (full text)"
    ...
    year: 2024
  - title: "Pope Francis Calls for the Inclusion of Trans People in Catholic Church Practices – GLAAD"
    url: "https://glaad.org/pope-francis-calls-for-the-inclusion-of-trans-people-in-catholic-practices/"
    year: 2023
  - title: "U.S. bishops officially ban gender-affirming care at Catholic hospitals – NPR"
    url: "https://www.npr.org/2025/11/12/g-s1-97651/gender-affirming-care-ban-catholic-hospitals"
    year: 2025
  - title: "A milestone reached in mainline Protestant churches' decades-old disputes over LGBTQ inclusion – AP"
    url: "https://www.sandiegouniontribune.com/2024/05/05/a-milestone-reached-in-mainline-protestant-churches-decades-old-disputes-over-lgbtq-inclusion/"
    year: 2024
  - title: "Islamic shari'a law, neotraditionalist Muslim scholars and transgender sex-reassignment surgery – International Journal of Transgenderism"
    url: "https://www.tandfonline.com/doi/full/10.1080/15532739.2016.1250239"
    year: 2016
  - title: "Transgender rights in Iran – Wikipedia"
    url: "https://en.wikipedia.org/wiki/Transgender_rights_in_Iran"
    year: 2024
  - title: "The Seven Genders in the Talmud – My Jewish Learning"
    url: "https://www.myjewishlearning.com/article/the-eight-genders-in-the-talmud/"
    year: 2023
  - title: "What the Torah Teaches Us About Gender Fluidity and Transgender Justice – Religious Action Center of Reform Judaism"
    url: "https://rac.org/blog/what-torah-teaches-us-about-gender-fluidity-and-transgender-justice"
    year: 2023
  ...
  - title: "Transsexualism in Hindu Mythology – PMC / National Library of Medicine"
    ...
    year: 2020
  - title: "In U.S., views on transgender issues vary widely by religion – Pew Research Center"
    url: "https://www.pewresearch.org/short-reads/2022/07/07/attitudes-about-transgender-issues-vary-widely-among-christians-religious-nones-in-u-s/"
    year: 2022
  - title: "Religious groups' policies on transgender members vary widely – Pew Research Center"
    url: "https://www.pewresearch.org/short-reads/2015/12/02/religious-groups-policies-on-transgender-members-vary-widely/"
    year: 2015
  - title: "Heads of Major American Religious Traditions Issue Landmark Statement Supporting Trans, Intersex and Nonbinary People – UUA"
    url: "https://www.uua.org/pressroom/press-releases/interfaith-statement-trans-support"
    year: 2023
  - title: "Le persone transgender potranno battezzarsi: critiche dalle frange cattoliche tradizionaliste – Euronews"
    url: "https://it.euronews.com/2023/11/10/le-persone-transgender-potranno-battezzarsi-critiche-dalle-frange-cattoliche-tradizionalis"
    year: 2023
  - title: "Giubileo, oltre mille persone Lgbtq+ bussano alla Porta Santa della chiesa – Domani"
    url: "https://www.editorialedomani.it/fatti/giubileo-pellegrinaggio-lgbt-chiesa-cattolica-yqmjjpq6"
    year: 2025
faq:
  - question: "La Bibbia condanna esplicitamente le persone trans?"
    answer: "No. La Bibbia non contiene riferimenti diretti all'identità transgender come la intendiamo oggi. I passaggi citati più frequentemente (come Deuteronomio 22:5 sul vestiario) sono oggetto di interpretazioni molto diverse tra studiosi e teologi. Molte denominazioni cristiane sottolineano che questi testi vanno letti nel loro contesto storico e culturale, non come pronunciamenti sull'identità di genere contemporanea."
  - question: "È vero che nell'islam la transizione di genere è permessa?"
    answer: "Dipende dalla tradizione e dal contesto. In Iran, una fatwa dell'Ayatollah Khomeini del 1985 ha legalizzato la riassegnazione chirurgica di genere, e lo stato offre sussidi per gli interventi. In Egitto, lo Sheikh al-Tantawi emise un parere simile. Tuttavia, molti altri studiosi islamici considerano la transizione vietata. Non esiste una posizione unica nell'islam, così come non esiste un'autorità centralizzata paragonabile al papato cattolico."
  - question: "Esistono davvero più di due generi nella tradizione ebraica?"
    answer: "Sì. La Mishnah e il Talmud descrivono almeno sei categorie di genere/sesso: zachar (maschio), nekevah (femmina), androgynos (caratteristiche di entrambi), tumtum (biologia indeterminata), aylonit (assegnata femmina alla nascita, sviluppa caratteristiche maschili alla pubertà) e saris (assegnato maschio alla nascita, sviluppa caratteristiche femminili). Queste categorie erano utilizzate per applicare le norme della halakhah."
  - question: "Posso essere una persona trans e credente?"
    answer: "Assolutamente sì, e non sei sola/o. Milioni di persone nel mondo vivono sia la propria identità di genere sia la propria fede. Esistono comunità religiose esplicitamente accoglienti in quasi tutte le tradizioni di fede. In Italia, organizzazioni come La Tenda di Gionata e i gruppi di fedeli LGBT cattolici offrono spazi di spiritualità inclusiva."
...
## Cristianesimo: un panorama frammentato
...
Le Chiese ortodosse orientali mantengono generalmente posizioni conservative, considerando l'identità di genere inscindibile dal sesso biologico e opponendosi alla transizione medica. Tuttavia, esistono voci minoritarie all'interno del mondo ortodosso che promuovono un approccio più dialogante e pastorale.
...
1. **Zachar** — maschio
2. **Nekevah** — femmina
3. **Androgynos** — persona con caratteristiche sia maschili che femminili
4. **Tumtum** — persona la cui biologia è indeterminata o nascosta
...
## Induismo e buddhismo: il terzo genere
...
I testi buddhisti antichi menzionano diverse categorie di genere non binario. Il **Vinaya** (la disciplina monastica) discute in dettaglio i casi di persone *ubhatovyanjanaká* (con caratteristiche di entrambi i generi) e *pandaka* (categoria complessa, variamente interpretata). Il Buddha stesso, secondo le scritture, fu relativamente tollerante verso le persone il cui genere veniva scoperto come non conforme solo dopo l'ordinazione, e ci sono esempi di queste persone che rimasero nella comunità monastica, rispettate per il loro avanzamento spirituale.

Il Dalai Lama ha espresso posizioni sfumate, accettando l'identità transgender dal punto di vista secolare e dei diritti umani, pur mantenendo alcune riserve dal punto di vista della disciplina monastica tradizionale. In Thailandia, paese a maggioranza buddhista, le *kathoey* (persone di terzo genere) hanno una visibilità sociale elevata, anche se il riconoscimento legale resta limitato.

## Il contesto italiano: tra dottrina e accoglienza
...
Dodici anni di pontificato di Francesco hanno lasciato un segno nello stile — gesti, incontri, parole nuove — senza modificare sostanzialmente la dottrina. Il risultato, per molte persone trans credenti, è un'esperienza paradossale: sentirsi accolte dal pastore e rifiutate dall'istituzione.

## Persone trans di fede: conciliare identità e spiritualità

Per molte persone trans, la fede non è qualcosa da cui fuggire ma una dimensione fondamentale della propria vita. La sfida sta nel trovare spazi in cui entrambe le dimensioni — identità di genere e spiritualità — possano coesistere senza che una debba essere sacrificata all'altra.
...
In quasi tutte le tradizioni di fede esistono oggi organizzazioni che lavorano specificamente per l'inclusione delle persone trans:

- **New Ways Ministry** (cattolico): promuove la giustizia e la riconciliazione per le persone LGBT all'interno della Chiesa cattolica.
- **Transmission Ministry Collective**: comunità online dedicata alla cura spirituale e alla formazione nella fede di cristiani transgender, creata da persone trans per persone trans.
- **Keshet** (ebraico): lavora per l'uguaglianza delle persone LGBTQ+ all'interno della vita ebraica.
- **Muslims for Progressive Values**: rete internazionale che promuove interpretazioni inclusive dell'islam.
