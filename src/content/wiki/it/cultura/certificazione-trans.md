---
lang: "it"
translationKey: "certificazione-trans"
title: "Serve una certificazione per essere trans?"
seoTitle: "È necessaria una certificazione per definirsi trans?"
...
sources:
  ...
  - title: "Standards of Care for the Health of Transgender and Gender Diverse People, Version 8 — WPATH"
    ...
    year: 2022
  - title: "ICD-11 and the Depathologisation of the Transgender Condition — Revista de Psiquiatría y Salud Mental"
    url: "https://www.elsevier.es/en-revista-revista-psiquiatria-salud-mental-486-articulo-icd-11-depathologisation-transgender-condition-S2173505019300214"
    year: 2019
  - title: "\"Mental Readiness\" and Gatekeeping in Trans Healthcare — PMC"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9561692/"
    year: 2022
  - title: "Systemic Transphobia and Ongoing Barriers to Healthcare for Transgender and Nonbinary People — PLOS Digital Health"
    url: "https://journals.plos.org/digitalhealth/article?id=10.1371/journal.pdig.0000718"
    year: 2025
  - title: "Legge 14 aprile 1982, n. 164 — Norme in materia di rettificazione di attribuzione di sesso"
    url: "https://www.studiolegaleparigiani.it/legge-14-aprile-1982-n-164/"
    year: 1982
  - title: "Corte costituzionale — Sentenza 221/2015: rettifica dell'attribuzione del sesso"
    ...
    year: 2015
  - title: "InfoTrans — Il percorso di affermazione di genere in pillole (ISS / UNAR)"
    url: "https://www.infotrans.it/it-schede-7-percorso_affermazione_genere_transgender"
    year: 2020
  - title: "Appropriatezza terapeutica nelle persone transgender — Istituto Superiore di Sanità"
    url: "https://www.iss.it/documents/20126/6744468/Appropriatezza+terapeutica+nelle+persone+transgender.pdf"
    year: 2022
  - title: "Gender Identity Law (Argentina) — Wikipedia"
    url: "https://en.wikipedia.org/wiki/Gender_Identity_Law_(Argentina)"
    year: 2012
  - title: "Malta Gender Identity, Gender Expression and Sex Characteristics Act — Human Rights Watch"
    url: "https://www.hrw.org/news/2015/04/01/dispatches-maltas-inspiring-gender-recognition-law"
    year: 2015
  - title: "Sempre più Paesi europei permettono di cambiare genere con un'autocertificazione — EuropaToday"
    url: "https://europa.today.it/attualita/europa-cambio-genere-lgbt.html"
    year: 2024
  - title: "Disorders Related to Sexuality and Gender Identity in the ICD-11 — PMC (Reed et al.)"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC5032510/"
    year: 2016
  - title: "It's Time to Stop Gatekeeping Medical Transition — American Scientist"
    url: "https://www.americanscientist.org/blog/macroscope/its-time-to-stop-gatekeeping-medical-transition"
    year: 2023
faq:
  - question: "Serve una diagnosi per essere trans?"
    answer: "No. L'identità di genere è un'esperienza personale che non richiede alcuna certificazione per essere valida. L'OMS ha spostato l'incongruenza di genere fuori dai disturbi mentali nell'ICD-11. Una diagnosi può essere necessaria per accedere a percorsi medici o legali, ma non per definire chi sei."
  - question: "Cosa serve in Italia per cambiare nome e genere sui documenti?"
    answer: "In Italia serve un procedimento giudiziario presso il tribunale, che può richiedere una consulenza tecnica psicologica. Dal 2015 la Corte Costituzionale ha stabilito che l'intervento chirurgico non è obbligatorio. La procedura è regolata dalla Legge 164/1982."
  - question: "Cos'è il modello del consenso informato?"
    answer: "È un approccio alle cure di affermazione di genere in cui la persona riceve tutte le informazioni su rischi, benefici e alternative del trattamento, e decide autonomamente se procedere. Sostituisce il vecchio modello del gatekeeping, dove era il professionista a decidere se la persona fosse 'pronta'."
  - question: "Esistono Paesi dove non serve nessuna procedura medica per il riconoscimento di genere?"
    answer: "Sì. Argentina (dal 2012), Danimarca (dal 2014), Malta (dal 2015) e molti altri Paesi consentono il cambio dei documenti tramite semplice dichiarazione, senza requisiti medici o psicologici. L'Italia non ha ancora adottato questo modello."
related:
...
La domanda arriva spesso, in forme diverse. "Ma hai il certificato?". "Hai fatto la diagnosi?". "Chi ti ha detto che sei trans?". Come se l'identità di una persona avesse bisogno di un timbro per esistere. Come se servisse un pezzo di carta per rendere reale qualcosa che si sente dentro da sempre.

Facciamo chiarezza: **no, non serve una certificazione medica per essere transgender**. L'identità di genere è un'esperienza personale e soggettiva che non dipende da una diagnosi, da un referto o dall'approvazione di un professionista. Tuttavia, la situazione si complica quando si parla di accesso a percorsi medici e di riconoscimento legale -- due ambiti in cui la burocrazia e la medicina si intrecciano in modi che è importante comprendere.

Questo articolo spiega cosa dice la scienza, cosa prevede la legge italiana, come funziona in altri Paesi e perché il modo in cui il mondo affronta queste questioni sta cambiando.
...
## Il gatekeeping: quando il sistema decide al posto tuo
...
L'Italia non è sola nella sua impostazione, ma non è nemmeno all'avanguardia. Diversi Paesi hanno adottato modelli basati sull'**autodeterminazione**, in cui il riconoscimento legale dell'identità di genere non richiede alcuna valutazione medica o psicologica.
...
## "Ma se non c'è una diagnosi, come si fa a sapere?"
...
## Cosa fare nella pratica: consigli per orientarsi

Se sei una persona transgender in Italia e stai pensando a come muoverti, ecco alcune informazioni pratiche.
...
Va benissimo. Non tutte le persone transgender scelgono un percorso medico o legale. Alcune scelgono solo una transizione sociale -- cambiare nome, pronomi, presentazione -- senza coinvolgere ospedali o tribunali. Altre non fanno nulla di visibile all'esterno e trovano pace semplicemente nell'aver compreso chi sono. Nessuna di queste scelte è più o meno valida delle altre.
...
## La tua identità non ha bisogno di un timbro

Puoi essere transgender senza aver mai visto uno psicologo. Puoi essere transgender senza terapia ormonale, senza interventi chirurgici, senza aver cambiato i documenti. Puoi essere transgender senza che nessuno ti abbia mai detto "sì, lo sei". L'identità di genere è tua. Non è del tuo medico, non è del tribunale, non è dello Stato.
