---
lang: "it"
translationKey: "sex-work-persone-trans"
title: "Persone trans e sex work: dati e realtà"
seoTitle: "È vero che le persone trans lavorano tutte nel sesso?"
...
sources:
  - title: "2022 U.S. Transgender Survey: Early Insights Report"
    url: "https://transequality.org/sites/default/files/2024-02/2022%20USTS%20Early%20Insights%20Report_FINAL.pdf"
    year: 2024
  - title: "Workplace Experiences of Transgender Employees -- Williams Institute, UCLA School of Law"
    url: "https://williamsinstitute.law.ucla.edu/publications/transgender-workplace-discrim/"
    year: 2024
  - title: "Discriminazioni lavorative nei confronti delle persone LGBT+ (persone trans e non binarie) -- Anno 2023, ISTAT-UNAR"
  ...
  - title: "Transgender women and the sex work industry: roots in systemic, institutional, and interpersonal discrimination"
    url: "https://pubmed.ncbi.nlm.nih.gov/24313294/"
    year: 2013
  - title: "EU LGBTIQ Survey III: LGBTIQ Equality at a Crossroads -- FRA, European Union Agency for Fundamental Rights"
    url: "https://fra.europa.eu/en/publication/2024/lgbtiq-equality-crossroads-progress-and-challenges"
    year: 2024
  - title: "Trans Murder Monitoring 2025 -- TGEU, Transgender Europe"
    ...
    year: 2025
  - title: "The Report of the 2015 U.S. Transgender Survey -- National Center for Transgender Equality"
    url: "https://transequality.org/sites/default/files/docs/usts/USTS-Full-Report-Dec17.pdf"
    year: 2016
  - title: "Persone transgender e messaggi mediatici negativi -- Istituto Beck"
    url: "https://www.istitutobeck.com/beck-news/persone-transgender-e-messaggi-mediatici-negativi"
    year: 2021
  - title: "WHy sex work? -- Trans Income Project"
    url: "https://www.transincomeproject.org/sexwork"
    year: 2023
  - title: "Transgender Workers at Greater Risk for Unemployment and Poverty -- Movement Advancement Project"
    url: "https://www.lgbtmap.org/news/a-broken-bargain-for-transgender-workers-release"
    year: 2023
  - title: "Sex Work Patterns Among Transgender and Gender Diverse People: A Latent Class Analysis -- Journal of Homosexuality"
    url: "https://www.tandfonline.com/doi/full/10.1080/00918369.2024.2415419"
    year: 2024
  - title: "La prima violenza che subiscono le persone trans è il modo in cui parliamo di loro -- The Vision"
    url: "https://thevision.com/attualita/media-persone-trans/"
    year: 2022
faq:
  - question: "È vero che le persone trans lavorano tutte nel sex work?"
    answer: "No. Secondo i dati disponibili, circa l'87% delle persone trans negli Stati Uniti non ha mai svolto sex work. La grande maggioranza lavora negli stessi settori della popolazione generale: istruzione, sanità, commercio, tecnologia e altri."
  - question: "Perché esiste lo stereotipo che associa le persone trans al sex work?"
    answer: "Lo stereotipo nasce dalla combinazione di rappresentazioni mediatiche distorte, dalla sovraesposizione di un unico tipo di narrativa e dalla storia di marginalizzazione economica che ha reso alcune persone trans più visibili nel contesto della strada, alimentando una generalizzazione infondata."
  - question: "Perché alcune persone trans svolgono sex work?"
    answer: "La ricerca indica che la discriminazione lavorativa sistemica è il principale fattore: il rifiuto nei colloqui, il mobbing sul posto di lavoro e la mancanza di tutele legali spingono alcune persone trans -- soprattutto donne trans, e in particolare quelle di colore -- verso il sex work come forma di sopravvivenza economica."
  - question: "Come si può contrastare questo stereotipo?"
    answer: "Informandosi sui dati reali, evitando di generalizzare l'esperienza di un gruppo eterogeneo, sostenendo politiche contro la discriminazione lavorativa e promuovendo rappresentazioni mediatiche che mostrino la varietà delle vite delle persone trans."
related:
...
Questo articolo esamina i dati disponibili per smontare lo stereotipo e, contemporaneamente, analizzare le cause strutturali che spingono alcune persone trans verso il lavoro sessuale.
...
Se la realtà è così diversa dal pregiudizio, perché l'associazione tra persone trans e sex work è così radicata nell'immaginario collettivo? Le ragioni sono multiple e si intrecciano.
...
In Italia, lo stereotipo ha anche radici storiche concrete. Negli anni Settanta e Ottanta, per molte persone trans -- in particolare donne trans -- la prostituzione rappresentava una delle poche possibilità di sostentamento in un contesto di totale esclusione sociale e lavorativa. In quei decenni, essere trans significava spesso essere espulse dalla famiglia, non avere documenti coerenti con la propria identità e subire retate da parte della polizia.

Quella realtà, per quanto storicamente documentata, si è cristallizzata nell'immaginario collettivo come se fosse immutabile. Ma il contesto è cambiato: le persone trans oggi accedono a una gamma più ampia di percorsi professionali, anche se le barriere restano significative, come vedremo.

### La visibilità selettiva

C'è un meccanismo cognitivo alla base di molti pregiudizi: la visibilità selettiva. Le persone trans che svolgono sex work in strada sono visibili; le persone trans che lavorano in ufficio, in ospedale, in un laboratorio o in un'azienda no. L'occhio vede ciò che conferma la propria aspettativa e ignora tutto il resto. Questo bias di conferma alimenta lo stereotipo e lo rende resistente ai dati.

## La realtà della discriminazione lavorativa

Se vogliamo comprendere perché una percentuale -- minoritaria ma reale -- di persone trans svolge sex work, dobbiamo guardare le condizioni strutturali che limitano le alternative.
...
## Perché lo stigma fa danno a tutti

Lo stereotipo che associa le persone trans al sex work non danneggia solo chi effettivamente svolge questo lavoro. Ha effetti a catena sull'intera comunità.

**Per le persone trans che non svolgono sex work**, lo stereotipo alimenta pregiudizi nei colloqui di lavoro, nei contesti sociali e nella vita quotidiana. Essere viste attraverso la lente della sessualizzazione rende più difficile essere riconosciute come professioniste, colleghe, vicine di casa, persone qualunque.

**Per le persone trans che svolgono sex work**, la doppia stigmatizzazione -- essere trans e fare sex work -- le rende invisibili al dibattito pubblico se non come oggetto di cronaca nera o di moralismo. Le politiche di contrasto alla tratta, quando sono formulate senza considerare la specificità della condizione trans, possono paradossalmente aumentare la vulnerabilità delle sex worker trans anziché proteggerle.

**Per la società nel suo insieme**, lo stereotipo semplifica una questione complessa e impedisce di affrontare le cause strutturali: la discriminazione lavorativa, la mancanza di tutele legali specifiche, l'assenza di percorsi di reinserimento professionale adeguati.
