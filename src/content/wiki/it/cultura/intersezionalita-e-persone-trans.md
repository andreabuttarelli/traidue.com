---
lang: "it"
translationKey: "intersezionalita-e-persone-trans"
title: "Intersezionalità e persone trans: quando le discriminazioni si sommano"
seoTitle: "Cosa significa essere trans e appartenere ad altre minoranze?"
...
sources:
  - title: "Demarginalizing the Intersection of Race and Sex: A Black Feminist Critique of Antidiscrimination Doctrine, Feminist Theory and Antiracist Politics -- Kimberlé Crenshaw"
    url: "https://chicagounbound.uchicago.edu/uclf/vol1989/iss1/8/"
    year: 1989
  - title: "Mapping the Margins: Intersectionality, Identity Politics, and Violence Against Women of Color -- Kimberlé Crenshaw"
    url: "https://www.jstor.org/stable/1229039"
    year: 1991
  - title: "2015 U.S. Transgender Survey -- National Center for Transgender Equality"
  ...
  - title: "UNAR -- Strategia Nazionale LGBT+ 2022-2025"
    ...
    year: 2022
  - title: "MIT -- Casa Caterina: il primo rifugio per persone trans rifugiate in Europa"
    url: "https://mit-italia.it/chi-siamo/"
    year: 2024
  - title: "Factors That Drive Mental Health Disparities and Promote Well-Being in Transgender and Nonbinary People -- Nature Reviews Psychology"
    url: "https://www.nature.com/articles/s44159-022-00109-0"
    year: 2022
  - title: "ILGA-Europe -- Annual Review Italy 2024"
  ...
  - title: "ISS -- Comunicato Stampa N.41/2022: salute di genere nella popolazione transgender"
    ...
    year: 2022
faq:
  - question: "Cosa significa intersezionalità applicata alle persone trans?"
    answer: "Significa riconoscere che l'esperienza di una persona trans non è determinata solo dall'identità di genere, ma dall'interazione tra questa e altre caratteristiche come la razza, la classe sociale, la disabilità, lo status migratorio e l'età. Queste identità non si sommano semplicemente: si intrecciano, producendo forme di discriminazione specifiche che non possono essere comprese analizzando ogni fattore isolatamente."
  - question: "Le persone trans di colore subiscono più discriminazione?"
    answer: "Sì, i dati lo confermano in modo coerente. Negli Stati Uniti, il 42% delle persone trans di colore vive in povertà, contro il 23% delle persone trans bianche. Il tasso di violenza è drasticamente più alto: l'88% delle vittime di omicidio trans monitorate a livello globale da TGEU nel 2025 erano persone di colore. In Europa, la terza indagine FRA mostra che le persone LGBTIQ+ appartenenti a minoranze etniche riportano livelli più elevati di discriminazione e violenza."
  - question: "In Italia esistono servizi specifici per persone trans migranti?"
    answer: "Sì, ma sono pochi e concentrati nel Centro-Nord. Il MIT di Bologna gestisce Casa Caterina, il primo rifugio protetto in Europa per persone trans rifugiate e richiedenti asilo. Alcune sezioni locali di Arcigay offrono sportelli dedicati. Tuttavia, la copertura territoriale è insufficiente e molte persone trans migranti, soprattutto nel Sud e nelle isole, non hanno accesso a servizi dedicati."
  - question: "Perché l'approccio intersezionale è importante per i diritti trans?"
    answer: "Perché un approccio che non consideri le differenze interne alla comunità trans rischia di progettare politiche e servizi che funzionano solo per chi ha meno barriere -- tipicamente persone trans bianche, di classe media, cittadine del paese in cui risiedono. L'intersezionalità consente di identificare chi è più vulnerabile e di dare priorità alle risposte dove il bisogno è maggiore."
related:
...
La [storia del movimento trans](/wiki/storia-movimento-trans) è segnata da questa realtà. Marsha P. Johnson e Sylvia Rivera -- figure centrali delle rivolte di Stonewall nel 1969 -- erano entrambe persone di colore e di bassa estrazione sociale. Le persone più esposte alla violenza sono state spesso anche le più determinate nel lottare per i diritti di tutti.
...
In Italia, la possibilità concreta di vivere la propria identità di genere dipende in modo significativo da dove si nasce e da dove si vive. I principali [centri di identità di genere](/wiki/trans-e-sanita) -- CIDIGEM a Torino, il Progetto C.A.R.E. a Firenze, il SAIFIP a Roma -- sono concentrati nel Centro-Nord. Per un adolescente trans che vive in Calabria o in Sardegna, accedere a un percorso di affermazione di genere significa spesso spostarsi di centinaia di chilometri, con costi di viaggio e soggiorno interamente a proprio carico.
...
Un esempio concreto: la carriera alias in ambito lavorativo, descritta nell'articolo sulla [discriminazione lavorativa](/wiki/discriminazione-lavoro-trans-italia), è una buona pratica che consente ai dipendenti trans di utilizzare il nome scelto nei contesti interni all'azienda. Ma per una persona trans che non ha un lavoro -- perché è migrante senza permesso, perché è disabile e priva di collocamento mirato, perché vive in un'area con altissima disoccupazione -- la carriera alias è irrilevante. Il suo problema è a monte: accedere al mercato del lavoro.
