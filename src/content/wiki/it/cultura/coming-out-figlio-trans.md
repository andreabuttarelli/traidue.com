---
lang: "it"
translationKey: "coming-out-figlio-trans"
title: "Il coming out di un figlio trans"
seoTitle: "Come reagire se mio figlio fa coming out trans?"
...
sources:
  ...
  - title: "Intervenable Factors Associated with Suicide Risk in Transgender Persons: A Respondent Driven Sampling Study in Ontario, Canada"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC4450977/"
    year: 2015
  - title: "Impacts of Strong Parental Support for Trans Youth (Trans PULSE Project)"
    url: "https://transpulseproject.ca/research/impacts-of-strong-parental-support-for-trans-youth/"
    year: 2012
  ...
  - title: "The Trevor Project: 2022 National Survey on LGBTQ Youth Mental Health"
    ...
    year: 2022
  - title: "Family Functioning and Mental Health of Transgender and Gender Nonconforming Youth in the Trans Teen and Family Narratives Project"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC7895334/"
    year: 2018
  - title: "Infotrans.it — Portale istituzionale per le persone transgender (ISS / UNAR)"
    url: "https://www.infotrans.it/"
    year: 2020
  - title: "Child, Family, and Community Transformations: Findings from Interviews with Mothers of Transgender Girls"
    url: "https://www.researchgate.net/publication/272121738_Child_Family_and_Community_Transformations_Findings_from_Interviews_with_Mothers_of_Transgender_Girls"
    year: 2014
faq:
  - question: "Come reagire al coming out trans di un figlio?"
    answer: "Ringraziatelo per la fiducia. Non serve capire tutto subito. Dite: 'Ti voglio bene, sono qui per te'. Gli studi dimostrano che la prima reazione dei genitori ha un impatto profondo e duraturo sul benessere del figlio."
  - question: "È una fase passeggera?"
    answer: "Nella grande maggioranza dei casi, no. I giovani che comunicano la propria identità di genere in modo persistente e consistente hanno altissime probabilità di mantenere quell'identità. Il tasso di 'desistenza' è molto più basso di quanto si pensasse."
  - question: "Cosa NON dire a un figlio che fa coming out trans?"
    answer: "Evitate frasi come 'è solo una fase', 'sei troppo giovane per sapere', 'lo fai per attirare l'attenzione'. Queste risposte sono associate a un aumento significativo di depressione, ansia e rischio suicidario nei giovani trans."
  - question: "Dove trovare supporto come genitori?"
    answer: "In Italia: AGEDO (associazione genitori), GenderLens, Infotrans.it (portale ISS/UNAR). Molti centri di identità di genere offrono anche percorsi di supporto per le famiglie."
related:
...
- Informatevi. Leggere questo articolo è già un primo passo. Il portale [Infotrans.it](https://www.infotrans.it/), realizzato dall'Istituto Superiore di Sanità e dall'UNAR, è una risorsa istituzionale affidabile [11].
...
**AGEDO** (Associazione di Genitori, Parenti e Amici di persone LGBT+) è presente con 37 sedi su tutto il territorio nazionale. Fondata nel 1992, offre gruppi di ascolto, supporto tra pari e orientamento. Il valore di AGEDO sta soprattutto nel confronto con altri genitori che hanno attraversato lo stesso percorso. Sito: [agedonazionale.org](https://www.agedonazionale.org/). Email: info@agedonazionale.org.

**GenderLens** è un'associazione composta da genitori di bambini con varianza di genere, giovani transgender e professionisti specializzati. Offre gruppi di condivisione mensili (anche online), supporto individuale per le famiglie e un approccio esplicitamente non patologizzante. Sito: [genderlens.org](https://www.genderlens.org/).

**Infotrans.it** è il portale istituzionale realizzato dall'Istituto Superiore di Sanità e dall'UNAR (Ufficio Nazionale Antidiscriminazioni Razziali) [11]. Contiene una mappa di tutti i centri, le associazioni e i servizi dedicati alle persone transgender in Italia. Sito: [infotrans.it](https://www.infotrans.it/).
