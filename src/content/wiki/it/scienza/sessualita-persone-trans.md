---
lang: "it"
translationKey: "sessualita-persone-trans"
...
sources:
  - title: "Standards of Care for the Health of Transgender and Gender Diverse People, Version 8 (WPATH SOC-8)"
    ...
    year: 2022
  - title: "Sexual Desire Changes in Transgender Individuals Upon Initiation of Hormone Treatment: Results From the Longitudinal European Network for the Investigation of Gender Incongruence (ENIGI)"
  ...
  - title: "Prevalence of Sexual Dysfunctions in Transgender Persons: Results from the ENIGI Follow-Up Study"
    ...
    year: 2019
  - title: "Sexual Dysfunction in Transgender People: A Systematic Review"
    url: "https://pubmed.ncbi.nlm.nih.gov/34602167/"
    year: 2021
  - title: "Supporting sexuality and improving sexual function in transgender persons"
    url: "https://www.nature.com/articles/s41585-018-0108-8"
    year: 2019
  ...
  - title: "Transgender Transitioning and Change of Self-Reported Sexual Orientation"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC4192544/"
    year: 2014
  - title: "Sexual orientation in transgender individuals: results from the longitudinal ENIGI study"
    url: "https://www.nature.com/articles/s41443-020-00402-7"
    year: 2021
  - title: "Body Image and Sexual Desire in the Context of Gender Affirming Therapy: Results of a Cross-sectional Multi-centered Transgender Study"
    url: "https://pubmed.ncbi.nlm.nih.gov/33616008/"
    year: 2021
  ...
  - title: "Daily Sexual Behavior, Sexual Esteem, and Body Image in Transgender and Cisgender Individuals"
    url: "https://www.tandfonline.com/doi/full/10.1080/00224499.2022.2158172"
    year: 2023
faq:
  - question: "Le persone trans hanno una vita sessuale?"
    answer: "Sì. Come tutte le persone, le persone trans possono avere una vita sessuale soddisfacente. Gli studi mostrano che la transizione spesso migliora la qualità della vita sessuale e la soddisfazione corporea."
  - question: "La terapia ormonale cambia il desiderio sessuale?"
    answer: "Sì, la terapia ormonale può influenzare la libido. Il testosterone tende ad aumentarla, mentre gli estrogeni possono ridurla inizialmente, con un successivo assestamento. Gli effetti variano da persona a persona."
  - question: "L'orientamento sessuale cambia con la transizione?"
    answer: "L'orientamento sessuale e l'identità di genere sono aspetti distinti. Alcune persone scoprono nuove sfumature del proprio orientamento durante la transizione, ma questo riflette una maggiore autenticità, non un 'cambio'."
  - question: "Le persone trans possono avere orgasmi?"
    answer: "Sì. Sia con che senza interventi chirurgici, le persone trans possono provare piacere sessuale e raggiungere l'orgasmo. La sensibilità genitale viene preservata nelle procedure chirurgiche moderne."
related:
  - transizione-medica-cosa-cambia
  - rapporti-sessuali-donna-trans
  - rapporti-sessuali-uomo-trans
  - corpo-cambia-dopo-ormoni
---

La sessualità delle persone trans è un argomento circondato da curiosità, imbarazzo e, troppo spesso, da informazioni sbagliate. Esiste un immaginario distorto, alimentato dalla pornografia e dai pregiudizi, che riduce le persone transgender ai loro genitali o le descrive come sessualmente disfunzionali. La realtà scientifica racconta una storia diversa: le persone trans hanno vite sessuali variegate, complesse e soddisfacenti, proprio come chiunque altro. Questo articolo esamina cosa dicono le evidenze su desiderio, piacere, orientamento sessuale, effetti della transizione medica e intimità nelle relazioni. Non è un manuale: è un punto di partenza basato su dati reali.

## La sessualità è diversa, anche tra persone trans
...
La terapia ormonale è una delle domande più frequenti quando si parla di sessualità trans: cosa succede alla libido? La risposta breve è che gli ormoni influenzano il desiderio, ma in modo diverso e con tempi diversi. Per i dettagli su tutti gli effetti della terapia ormonale, rimandiamo all'articolo sulla [transizione medica](/wiki/transizione-medica-cosa-cambia).
...
Una delle domande più dirette che le persone si pongono: le persone trans provano piacere sessuale? La risposta è sì. Ma il piacere sessuale non è un interruttore: è un'esperienza complessa che dipende dal corpo, dalla mente, dalla relazione e dal contesto.
...
## Orientamento sessuale e identità di genere: due cose distinte

Una confusione molto diffusa riguarda il rapporto tra identità di genere e orientamento sessuale. Sono due dimensioni indipendenti. L'identità di genere riguarda chi sei; l'orientamento sessuale riguarda da chi sei attratta o attratto. Una donna trans può essere lesbica, eterosessuale, bisessuale o qualsiasi altra cosa, esattamente come una donna cisgender. Lo stesso vale per gli uomini trans e per le persone non binarie.
...
Il rapporto con il proprio corpo è forse il fattore più determinante nella sessualità delle persone trans. La disforia di genere, quando presente, può rendere estremamente difficile il contatto fisico e l'intimità.
...
Molte persone trans sviluppano strategie concrete per gestire la disforia durante il sesso: scegliere posizioni che riducono il disagio, usare vestiti o accessori durante l'intimità, comunicare apertamente con il partner su cosa è piacevole e cosa no, esplorare zone erogene al di là dei genitali. Queste strategie non sono segni di una sessualità "compromessa": sono forme di adattamento creativo che molte persone, trans e non, utilizzano per vivere il sesso in modo appagante.

## Intimità e comunicazione nella coppia

La transizione non avviene in un vuoto relazionale. Per le persone trans in relazione, la sessualità si intreccia con la dinamica di coppia, e la comunicazione diventa fondamentale.
...
- Le persone trans ricevano informazioni chiare sugli effetti della terapia ormonale e della chirurgia sulla sessualità
- Il supporto psicologico includa, quando richiesto, un focus sulla sessualità e sull'intimità

In Italia, i centri di genere principali (Careggi a Firenze, il Niguarda a Milano, il Policlinico di Bari, tra gli altri) offrono percorsi multidisciplinari che dovrebbero includere anche la consulenza sessuologica. Nella pratica, questo aspetto è spesso trascurato: la sessualità viene affrontata solo in termini di funzione (erezione, lubrificazione, orgasmo) e raramente in termini di piacere, desiderio e relazione.

### Cosa cercare

Se stai cercando supporto per la tua vita sessuale:

- **Sessuologi con competenze trans-specifiche**: non tutti i sessuologi hanno formazione sulla sessualità delle persone trans. Cercane uno con esperienza specifica o che faccia parte di un team multidisciplinare in un centro di genere.
- **Comunità e gruppi di pari**: molte associazioni LGBTQ+ organizzano gruppi di confronto dove si parla anche di sessualità. Il confronto con altre persone trans può essere prezioso per normalizzare esperienze che spesso vengono vissute in solitudine.
- **Informazioni online affidabili**: diffida di contenuti sensazionalistici. Cerca fonti che citino studi scientifici e che trattino l'argomento con rispetto.
