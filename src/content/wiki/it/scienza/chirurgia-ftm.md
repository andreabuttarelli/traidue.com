...
date: "2026-02-21"
updated: "2026-02-21"
image: "/images/wiki/chirurgia-ftm.webp"
sources:
  ...
  - title: "Il trattamento chirurgico di affermazione di genere – Infotrans"
    ...
    year: 2024
  - title: "Hysterectomy as Gender-Affirming Surgery: A Systematic Review of Outcomes"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9648977/"
    year: 2022
  - title: "Phalloplasty and metoidioplasty -- overview and postoperative considerations (UCSF Transgender Care)"
    ...
    year: 2024
faq:
  - question: "Quali interventi chirurgici esistono per gli uomini trans?"
    answer: "Gli interventi principali sono: la mastectomia (top surgery), che rimodella il torace; l'isterectomia e ovariectomia, che rimuovono utero e ovaie; la metoidioplastica, che crea un microfallo dal clitoride ingrandito dal testosterone; e la falloplastica, che costruisce un neofallo di dimensioni standard usando tessuto da un'altra parte del corpo. Non tutti gli uomini trans desiderano tutti questi interventi: molti scelgono solo la mastectomia."
  - question: "La mastectomia e obbligatoria per essere un uomo trans?"
    answer: "No. Nessun intervento chirurgico e obbligatorio. Molti uomini trans scelgono solo la mastectomia, altri non desiderano alcun intervento, altri ancora optano anche per la chirurgia genitale. La validita dell'identita di genere non dipende da quali procedure si scelgono. Dal 2015, la rettifica anagrafica in Italia non richiede interventi chirurgici."
  - question: "Quanto costa la chirurgia FTM in Italia?"
    answer: "Tramite il SSN, gli interventi principali (mastectomia, isterectomia, falloplastica, metoidioplastica) sono coperti, con liste di attesa da 2 a 5 anni. Privatamente, i costi variano: 4.000-8.000 euro per la mastectomia, 5.000-10.000 euro per l'isterectomia, 15.000-25.000 euro per la metoidioplastica, 20.000-50.000 euro per la falloplastica completa."
  - question: "Qual e la differenza tra metoidioplastica e falloplastica?"
    answer: "La metoidioplastica utilizza il clitoride ingrandito dal testosterone per creare un microfallo di 5-9 cm con sensibilita erogena al 100% e erezione naturale, ma dimensioni limitate. La falloplastica costruisce un neofallo di 12-16 cm con tessuto prelevato dall'avambraccio o dalla coscia, permettendo la penetrazione con protesi erettile, ma con un percorso chirurgico piu lungo e complesso. Nessuna delle due opzioni e superiore all'altra: dipende dalle priorita individuali."
  - question: "Quali sono i rischi della falloplastica?"
    answer: "La falloplastica e tra gli interventi piu complessi della chirurgia ricostruttiva. Le complicanze uretrali sono le piu frequenti: fistole nel 17-40% dei casi e stenosi nel 21-51%. Molte si risolvono spontaneamente o con interventi correttivi. Le protesi erettili hanno un tasso di re-intervento del 53%. Nonostante cio, la soddisfazione complessiva rimane alta e il rimpianto e inferiore all'1%. La scelta di un centro ad alto volume riduce significativamente i rischi."
related: ["chirurgia-affermazione-di-genere", "falloplastica-risultati", "corpo-cambia-dopo-ormoni", "transizione-medica-cosa-cambia", "legge-164-italia"]
---

La chirurgia di affermazione di genere per gli uomini trans comprende un insieme di procedure diverse, con finalita diverse e percorsi di recupero molto differenti tra loro. Questo articolo le presenta tutte in modo sistematico: cosa sono, come funzionano, quanto costano, dove si fanno in Italia, quali rischi comportano e cosa dicono i dati sulla soddisfazione. Non e un consiglio medico: e una guida informativa basata sulla letteratura scientifica, pensata per chi sta valutando le proprie opzioni o per chi vuole semplicemente capire. Per una panoramica che include anche gli interventi per le donne trans, rimandiamo all'articolo sulla [chirurgia di affermazione di genere](/wiki/chirurgia-affermazione-di-genere). Per i risultati specifici della chirurgia genitale, c'e l'approfondimento su [falloplastica e metoidioplastica](/wiki/falloplastica-risultati).
...
1. **Mastectomia (top surgery)**: spesso il primo intervento, a volte l'unico
2. **Isterectomia e ovariectomia**: se desiderate, generalmente dopo almeno un anno di terapia ormonale
3. **Chirurgia genitale (metoidioplastica o falloplastica)**: se desiderata, generalmente l'ultimo passaggio
...
Per approfondire gli effetti e le implicazioni della terapia ormonale a lungo termine, rimandiamo all'articolo su [cosa cambia nel corpo con la transizione medica](/wiki/transizione-medica-cosa-cambia) e a quello sulla [terapia ormonale a vita](/wiki/terapia-ormonale-a-vita).
...
3. **Allungamento uretrale** (opzionale): l'uretra viene estesa attraverso il microfallo per permettere la minzione in piedi. Questa componente aumenta il rischio di complicanze uretrali
