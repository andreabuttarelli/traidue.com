---
lang: "it"
translationKey: "terapia-ormonale-a-vita"
...
sources:
  ...
  - title: "Standards of Care for the Health of Transgender and Gender Diverse People, Version 8"
    ...
    year: 2022
  - title: "Long-Term Hormonal Treatment for Transgender People"
    url: "https://www.nature.com/articles/s41574-019-0312-9"
    year: 2020
  - title: "Long-term follow-up of bone mineral density and bone metabolism in transsexuals treated with cross-sex hormones"
    url: "https://pubmed.ncbi.nlm.nih.gov/9513956/"
    year: 1998
  - title: "Mortality and morbidity in transsexual subjects treated with cross-sex hormones (Asscheman et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/21266549/"
    year: 2011
  - title: "Long-term evaluation of cross-sex hormone treatment in transsexual persons (Wierckx et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/22906135/"
    year: 2012
  - title: "Venous thrombotic risk in transgender women undergoing estrogen therapy: a systematic review and metaanalysis"
    url: "https://pubmed.ncbi.nlm.nih.gov/30064109/"
    year: 2019
  - title: "Breast Cancer Risk in Transgender People Receiving Hormone Treatment: Nationwide Cohort Study in the Netherlands (de Blok et al.)"
    url: "https://www.bmj.com/content/365/bmj.l1652"
    year: 2019
  - title: "Hormone-related tumors in transsexuals receiving treatment with cross-sex hormones (Nota et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/30256230/"
    year: 2018
  - title: "Long-term Safety of Cyproterone Acetate in Transgender Men and Women (Wiepjes et al.)"
    ...
    year: 2019
  - title: "Cardiovascular disease in transgender people: a systematic review and meta-analysis"
    url: "https://academic.oup.com/ehjopen/article/3/2/oead018/7077222"
    year: 2023
...
faq:
  ...
  - question: "Cosa succede se si smette la terapia ormonale?"
    answer: "Dipende dalla situazione. Chi ha ancora le gonadi vedrà un ritorno parziale dei caratteri del sesso di nascita. Chi non le ha rischia osteoporosi, stanchezza, vampate e altri sintomi da carenza ormonale."
  - question: "La terapia ormonale è sicura a lungo termine?"
    answer: "Gli studi a lungo termine mostrano che i rischi sono paragonabili a quelli della terapia ormonale sostitutiva per le persone cisgender in menopausa o andropausa. Il monitoraggio regolare con esami del sangue è fondamentale."
  - question: "Ogni quanto vanno fatti i controlli?"
    answer: "Generalmente ogni 3-6 mesi nel primo anno, poi ogni 6-12 mesi. I controlli includono esami del sangue (livelli ormonali, funzionalità epatica, profilo lipidico) e valutazione clinica."
related:
...
Una delle domande più frequenti tra le persone trans che iniziano o stanno valutando la [terapia ormonale](/wiki/corpo-cambia-dopo-ormoni) è: "dovrò prendere ormoni per tutta la vita?". La risposta breve è: nella maggior parte dei casi, sì. Ma questa risposta merita un contesto molto più ampio, perché la gestione della terapia ormonale nel tempo è un argomento ricco di sfumature, e comprenderne i dettagli aiuta a viverla con serenità.

Questo articolo esplora la durata della terapia ormonale, cosa succede se viene interrotta, cosa dice la ricerca sulla sicurezza a lungo termine, come si gestisce il monitoraggio medico e come affrontare situazioni particolari come viaggi, interventi chirurgici e invecchiamento.

## Perché la terapia ormonale dura tutta la vita
...
## Con o senza gonadi: due scenari diversi

La necessità di continuare la terapia ormonale per tutta la vita dipende in modo cruciale dalla presenza o assenza delle gonadi originali (ovaie o testicoli).
...
La situazione è più complessa per chi non ha effettuato la gonadectomia. In questo caso, le gonadi originali sono ancora in grado di produrre ormoni sessuali, anche se la loro funzione è soppressa dalla terapia ormonale.

Se la terapia viene interrotta, le gonadi riprendono gradualmente la loro attività. Questo significa che:

- I livelli ormonali tornano progressivamente ai valori precedenti alla terapia
- I cambiamenti reversibili della terapia ormonale regrediscono (redistribuzione del grasso, massa muscolare, qualità della pelle)
...
Comprendere le conseguenze dell'interruzione è importante non solo per chi sta valutando di smettere, ma anche per gestire situazioni in cui la terapia viene temporaneamente sospesa (prima di un intervento chirurgico, durante un viaggio, per problemi di approvvigionamento).

### Interruzione con gonadi presenti

I cambiamenti non avvengono immediatamente. Nelle prime settimane si possono notare variazioni dell'umore e della libido. Nell'arco di settimane o mesi, il corpo inizia a tornare verso il profilo ormonale precedente. La velocità di questi cambiamenti varia da persona a persona.

Per le donne trans che interrompono gli estrogeni, il testosterone endogeno riprende la sua attività: si può osservare un ritorno della peluria, un aumento della massa muscolare, una redistribuzione del grasso e, in alcuni casi, erezioni più frequenti. Il seno sviluppato durante la terapia non regredisce in modo significativo.

Per gli uomini trans che interrompono il testosterone, gli estrogeni endogeni riprendono il sopravvento: il ciclo mestruale può tornare, il grasso si ridistribuisce verso i fianchi, la massa muscolare diminuisce. La voce resta grave e la barba sviluppata resta.
...
Una delle preoccupazioni più comprensibili riguarda la sicurezza dell'assunzione di ormoni per decenni. La ricerca su questo tema si è ampliata notevolmente negli ultimi anni e i dati sono nel complesso rassicuranti, pur evidenziando la necessità di un monitoraggio medico regolare.
...
- **Ogni 3 mesi:** esami del sangue per livelli ormonali (estradiolo e testosterone), emocromo completo, funzionalità epatica (transaminasi), profilo lipidico
- **Valutazione clinica:** pressione arteriosa, peso, valutazione degli effetti e degli eventuali effetti collaterali

### Anni successivi

- **Ogni 6-12 mesi:** stessi esami del sangue, con frequenza ridotta una volta raggiunti livelli stabili
- **Screening periodici:** densitometria ossea (DEXA) ogni 1-2 anni per chi ha fattori di rischio per l'osteoporosi, screening oncologici secondo le raccomandazioni per età e sesso
- **Valutazione cardiovascolare:** monitoraggio della pressione, del profilo lipidico e degli altri fattori di rischio
...
- Screening per il tumore della cervice uterina (se l'utero è presente)
- Screening mammografico (se la mastectomia non è stata effettuata)

## Invecchiamento e terapia ormonale

Con l'allungamento della vita media e il numero crescente di persone trans che raggiungono l'età avanzata, la gestione della terapia ormonale nell'invecchiamento sta diventando un tema sempre più rilevante.
...
Viaggiare con la terapia ormonale richiede un minimo di pianificazione:

- **Portare scorte sufficienti:** calcolare la quantità necessaria per l'intera durata del viaggio, più un margine di sicurezza
- **Documentazione medica:** portare una prescrizione o un certificato medico, specialmente quando si viaggia all'estero. Per i farmaci iniettabili (siringhe e fiale), la documentazione è particolarmente importante ai controlli aeroportuali
- **Conservazione:** il testosterone in fiale non richiede refrigerazione, l'estradiolo in compresse nemmeno. I cerotti transdermici vanno protetti dal calore eccessivo
- **Fuso orario:** per i farmaci che si assumono a orari fissi, adattare gradualmente l'orario di assunzione al nuovo fuso
...
In Italia, la terapia ormonale per le persone trans può essere prescritta nell'ambito del Servizio Sanitario Nazionale (SSN). Una volta ottenuta la diagnosi da un centro specializzato (come quelli che seguono i percorsi previsti dai protocolli ONIG o dalle linee guida delle singole regioni), i farmaci possono essere erogati con esenzione o a costo ridotto.

I costi variano a seconda della regione e del tipo di farmaco:

- **Estradiolo (compresse o cerotti):** con ricetta SSN, il costo è il ticket standard (pochi euro per confezione). Senza esenzione, il costo varia da 5 a 15 euro al mese
- **Testosterone (iniettabile o gel):** il testosterone enantato iniettabile è tra le formulazioni più economiche. Il gel transdermico costa di più ma è coperto dal SSN con ricetta appropriata
- **Anti-androgeni (ciproterone acetato, spironolattone):** costo contenuto con ricetta SSN
- **Esami del sangue:** con ricetta SSN, i costi sono limitati al ticket. Privatamente, un pannello completo può costare tra 50 e 150 euro

Le disparità regionali sono significative: alcune regioni offrono percorsi ben strutturati con copertura completa, altre rendono l'accesso più difficile. Le associazioni locali possono fornire informazioni aggiornate sulla situazione nella propria regione.

## Domande e preoccupazioni comuni

### "Non voglio dipendere da un farmaco per tutta la vita"

Questa preoccupazione è comprensibile e legittima. Può essere utile considerare che milioni di persone cisgender assumono terapie a lungo termine per condizioni croniche, dalla terapia ormonale sostitutiva in menopausa all'insulina per il diabete, dalla levotiroxina per l'ipotiroidismo ai farmaci per l'ipertensione. La terapia ormonale per le persone trans rientra nella stessa logica: è un trattamento che migliora la qualità della vita e protegge la salute, non una dipendenza.

### "E se i farmaci non fossero più disponibili?"

Le molecole utilizzate nella terapia ormonale (estradiolo, testosterone) sono farmaci essenziali prodotti da numerose aziende in tutto il mondo. Le carenze temporanee sono possibili per formulazioni specifiche (un particolare gel, un certo tipo di cerotto), ma alternative equivalenti sono sempre disponibili. La situazione è diversa da quella di farmaci altamente specializzati con un unico produttore.
