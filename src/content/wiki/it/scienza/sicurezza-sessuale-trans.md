---
lang: "it"
translationKey: "sicurezza-sessuale-trans"
...
La salute sessuale è un diritto di tutte le persone, indipendentemente dall'identità di genere. Eppure, attorno alla sessualità delle persone trans circolano domande a cui spesso non viene data una risposta chiara: servono precauzioni diverse? Come funziona la prevenzione con un corpo che sta cambiando? Quali screening sono necessari?

La risposta di partenza è semplice: **le regole fondamentali della salute sessuale sono le stesse per tutti**. Uso del preservativo, test regolari, comunicazione aperta con il partner. Non esistono "rischi speciali" legati all'essere trans. Esistono però specificità anatomiche e ormonali che è utile conoscere per prendersi cura di sé in modo completo.
...
Il preservativo esterno (maschile) si adatta a qualsiasi pene, ed è efficace indipendentemente dal fatto che la persona sia cis o trans. Il preservativo interno (femminile) può essere usato nella vagina, nella neovagina o nel retto. La scelta dipende dall'anatomia e dal tipo di rapporto, non dal genere.

Per le persone che hanno effettuato la vaginoplastica, il preservativo interno può essere utilizzato nella neovagina, ma è importante usare un lubrificante a base d'acqua in quantità sufficiente, poiché la neovagina non produce lubrificazione naturale. Per gli uomini trans che assumono testosterone, la stessa raccomandazione si applica: l'atrofia vaginale indotta dal testosterone riduce la lubrificazione e assottiglia le pareti vaginali, rendendo il lubrificante essenziale per ridurre il rischio di micro-lesioni.
...
Per le donne trans, la terapia estrogenica riduce drasticamente la produzione di spermatozoi, ma la fertilità residua può persistere, specialmente nei primi mesi di trattamento o in caso di interruzione temporanea. Se la partner può rimanere incinta, il preservativo resta il metodo più semplice e completo.

## Salute mentale e salute sessuale

La salute sessuale non riguarda solo il corpo: riguarda anche il modo in cui ci si sente nel proprio corpo durante l'intimità. Per molte persone trans, la disforia di genere può influenzare profondamente la vita sessuale. Parti del corpo possono generare disagio; la terminologia usata dal partner può risultare alienante; il contatto fisico può essere complesso da negoziare.

Questi aspetti non sono "problemi" della persona trans: sono il risultato dell'interazione tra un'esperienza di genere e un contesto che spesso non la riconosce. La comunicazione aperta con il partner è fondamentale. Stabilire insieme quali parole usare per descrivere il proprio corpo, quali tipi di contatto sono desiderati e quali no, è un elemento di salute sessuale tanto quanto l'uso del preservativo.
...
In Italia, l'accesso ai servizi di salute sessuale per le persone trans è possibile attraverso diverse strutture.

### Centri IST

Gli ambulatori per le infezioni sessualmente trasmissibili sono presenti in molte città italiane e offrono test gratuiti e anonimi per HIV, sifilide, epatite e altre IST. Tra i centri di riferimento:
...
La PrEP è disponibile in Italia dal 2023 tramite il Servizio Sanitario Nazionale. L'accesso avviene attraverso i centri di malattie infettive, che prescrivono il farmaco e monitorano i parametri clinici. Non è necessario dichiarare la propria identità di genere per accedere alla PrEP: il criterio è il rischio di esposizione all'HIV, valutato dal medico.
