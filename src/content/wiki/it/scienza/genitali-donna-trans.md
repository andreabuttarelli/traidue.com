---
lang: "it"
translationKey: "genitali-donna-trans"
...
"Che genitali ha una donna trans?" È una domanda che molte persone si pongono ma poche osano fare apertamente. Spesso la curiosità nasce da ignoranza, non da cattiveria. Il problema è che in assenza di risposte chiare, lo spazio viene riempito da stereotipi, pornografia e disinformazione. Questo articolo risponde con i dati: cosa succede al corpo di una donna trans prima, durante e dopo la transizione medica, con particolare attenzione all'anatomia genitale.

Premessa necessaria: non tutte le donne trans seguono lo stesso percorso. Alcune non intraprendono alcuna transizione medica. Altre assumono ormoni. Altre ancora si sottopongono a interventi chirurgici. Ogni combinazione è legittima, e nessuna rende una persona più o meno donna. Qui descriviamo cosa accade dal punto di vista anatomico e fisiologico a chi segue un percorso medico, secondo la letteratura scientifica disponibile.

## Anatomia di partenza

Le donne trans che non hanno ancora iniziato alcun trattamento medico hanno un'anatomia genitale tipicamente maschile: pene, scroto e testicoli. Questo dato anatomico non definisce la loro identità, ma è il punto di partenza da cui comprendere i cambiamenti successivi.

I genitali maschili sono composti da tessuti che, dal punto di vista embriologico, derivano dalle stesse strutture dei genitali femminili. Il glande del pene è il corrispettivo embrionale del clitoride: entrambi derivano dal tubercolo genitale e condividono la stessa innervazione e densità di recettori sensoriali. Le pieghe labio-scrotali, che nell'uomo formano lo scroto, nella donna formano le grandi labbra. Questa omologia è alla base delle tecniche chirurgiche di vaginoplastica: non si "crea" qualcosa dal nulla, ma si riorganizzano tessuti che hanno un corrispettivo anatomico femminile.
...
La terapia ormonale non modifica la struttura ossea del bacino, non rimuove i testicoli e non crea una vagina. I genitali restano anatomicamente maschili nella loro struttura di base, anche se profondamente modificati in termini di dimensioni, texture, funzionalità e sensibilità. Per un cambiamento anatomico strutturale, è necessaria la chirurgia.

## La vaginoplastica

La vaginoplastica è l'intervento chirurgico con cui si creano una neovagina, un neoclitoride e le strutture vulvari esterne (grandi e piccole labbra, cappuccio clitorideo, meato uretrale). Esistono diverse tecniche, ciascuna con vantaggi e limiti specifici.
...
Esistono anche la vaginoplastica con innesto di colon sigmoideo (meno praticata per la maggiore invasività) e varie tecniche ibride. La scelta della tecnica dipende dall'anatomia della paziente, dalla disponibilità di tessuti, dall'esperienza del chirurgo e dalle preferenze individuali.
...
Le foto "prima e dopo" disponibili online non sono rappresentative della variabilità reale dei risultati, e spesso mostrano solo i casi migliori. Un dialogo aperto con il chirurgo sulle aspettative è fondamentale.
...
Sapere come funziona l'anatomia delle donne trans è legittimo. Chiedere a una donna trans specifica che genitali ha, no. I genitali di qualsiasi persona, cis o trans, sono un dato privato. La curiosità non giustifica l'intrusione.

Se stai leggendo questo articolo perché hai una relazione con una donna trans, o stai pensando di averne una: quello che conta è il dialogo con la persona, non le informazioni generiche. Ogni corpo è diverso, ogni esperienza è individuale. Chiedi con rispetto, ascolta, e ricorda che l'intimità si costruisce sulla fiducia, non sulla curiosità soddisfatta a priori.

Se sei una donna trans e stai cercando informazioni per te stessa: questo articolo è un punto di partenza, non una guida medica. Ogni decisione sul tuo corpo spetta a te, con il supporto di professionisti competenti. Non esiste un percorso giusto o sbagliato: esiste il tuo.
