---
lang: "it"
translationKey: "sicurezza-transizione"
...
sources:
  - title: "Cornell University - What does the scholarly research say about the effect of gender transition on transgender well-being?"
    url: "https://whatweknow.inequality.cornell.edu/topics/lgbt-equality/what-does-the-scholarly-research-say-about-the-well-being-of-transgender-people/"
    year: 2018
  - title: "Murad MH et al. - Hormonal therapy and sex reassignment: a systematic review and meta-analysis of quality of life and psychosocial outcomes"
    url: "https://onlinelibrary.wiley.com/doi/10.1111/j.1365-2265.2009.03625.x"
    year: 2010
  - title: "de Vries ALC et al. - Young Adult Psychological Outcome After Puberty Suppression and Gender Reassignment"
  ...
  - title: "Bustos VP et al. - Regret after Gender-affirmation Surgery: A Systematic Review and Meta-analysis of Prevalence"
    ...
    year: 2021
  - title: "Getahun D et al. - Cross-sex Hormones and Acute Cardiovascular Events in Transgender Persons: A Cohort Study"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC6636681/"
    year: 2018
  - title: "Endocrine Society - Endocrine Treatment of Gender-Dysphoric/Gender-Incongruent Persons: Clinical Practice Guideline"
    url: "https://academic.oup.com/jcem/article/102/11/3869/4157558"
    year: 2017
  - title: "Coleman E et al. - Standards of Care for the Health of Transgender and Gender Diverse People, Version 8 (WPATH)"
    url: "https://www.tandfonline.com/doi/full/10.1080/26895269.2022.2100644"
    year: 2022
  - title: "Tordoff DM et al. - Mental Health Outcomes in Transgender and Nonbinary Youths Receiving Gender-Affirming Care"
    url: "https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2789423"
    year: 2022
  - title: "Almazan AN, Keuroghlian AS - Association Between Gender-Affirming Surgeries and Mental Health Outcomes"
  ...
  - title: "Boyd I et al. - A systematic review of patient regret after surgery: A common phenomenon in many specialties but rare within gender-affirmation surgery"
    ...
    year: 2024
  - title: "Frontiers in Endocrinology - Risk of Venous Thromboembolism in Transgender People Undergoing Hormone Feminizing Therapy: A Prevalence Meta-Analysis and Meta-Regression Study"
    url: "https://www.frontiersin.org/journals/endocrinology/articles/10.3389/fendo.2021.741866/full"
    year: 2021
  - title: "Singh-Ospina N et al. - Bone Mass Effects of Cross-Sex Hormone Therapy in Transgender People: Updated Systematic Review and Meta-Analysis"
  ...
  - title: "APA - Resolution on Gender Identity Change Efforts"
    ...
    year: 2021
faq:
  - question: "La transizione medica è sicura?"
    answer: "Sì. Le meta-analisi mostrano che la transizione medica migliora significativamente la qualità della vita, riduce la disforia di genere e abbassa i tassi di depressione e suicidio. I rischi esistono, come per qualsiasi trattamento medico, ma sono gestibili con un monitoraggio adeguato."
  - question: "Quante persone si pentono della transizione?"
    answer: "Meno del 2% secondo le meta-analisi più recenti. Inoltre, la maggior parte dei 'rimpianti' è legata a discriminazione sociale o risultati chirurgici insoddisfacenti, non al pentimento di aver transizionato."
  - question: "La transizione è sperimentale?"
    answer: "No. Le terapie ormonali per le persone trans sono studiate da oltre 50 anni. Le linee guida sono supportate da decenni di evidenze e approvate dalle principali organizzazioni mediche mondiali (OMS, APA, Endocrine Society, WPATH)."
  - question: "Quali sono i rischi della terapia ormonale?"
    answer: "I rischi includono trombosi venosa (soprattutto con estrogeni orali), variazioni del profilo lipidico e rari effetti epatici. Il monitoraggio regolare minimizza questi rischi, che rimangono bassi nella popolazione trans."
related:
...
"La transizione medica è sicura?" è una delle domande più frequenti -- e più strumentalizzate -- nel dibattito sulle persone transgender. Viene posta da genitori preoccupati, da pazienti che valutano il percorso, ma anche da chi cerca argomenti per limitare l'accesso alle cure. La risposta, come per qualsiasi trattamento medico, non è un semplice "sì" o "no": è un bilancio tra rischi e benefici, supportato da decenni di evidenze scientifiche.

Questo articolo esamina cosa dicono le meta-analisi, gli studi di coorte e le linee guida internazionali sulla sicurezza della transizione medica, senza nascondere i rischi reali ma contestualizzandoli in modo onesto.

## Cosa significa "sicuro" in medicina

In medicina nessun trattamento è privo di rischi. L'aspirina può causare emorragie gastriche. I contraccettivi orali aumentano il rischio tromboembolico. Le protesi al ginocchio hanno un tasso di insoddisfazione che sfiora il 20%. Nessuno di questi trattamenti viene definito "pericoloso" o "sperimentale": vengono valutati in base al rapporto rischio-beneficio.

Per la transizione medica si applica lo stesso principio. La domanda non è "ci sono rischi?" -- ci sono, come per ogni intervento medico. La domanda è: **i benefici superano i rischi?** E la risposta, secondo la letteratura peer-reviewed, è inequivocabilmente sì per la grande maggioranza delle persone che intraprendono questo percorso.

## Cosa dicono le meta-analisi sui benefici
...
- **80%** ha riportato un miglioramento della qualità della vita
- **72%** ha riportato un miglioramento della funzione sessuale

Questi numeri non descrivono un trattamento "sperimentale". Descrivono un trattamento con tassi di efficacia paragonabili o superiori a molte terapie consolidate in medicina.
...
La transizione medica non è solo una questione di cambiamenti fisici. Il suo impatto sulla salute mentale è documentato in modo esteso e coerente.
...
- **44% in meno** di ideazione suicidaria nell'anno precedente

Questi non sono numeri marginali. Sono differenze clinicamente significative che confermano che la chirurgia di affermazione di genere, per chi la desidera, ha un impatto positivo misurabile sulla salute mentale.

## I tassi di soddisfazione e rimpianto

Uno dei modi più diretti per valutare la sicurezza di un trattamento è chiedere ai pazienti se lo rifarebbero. Nel caso della transizione medica, i dati sono chiari.
...
Affermare che la transizione medica è sicura non significa negare l'esistenza di rischi. Significa che questi rischi sono noti, gestibili e complessivamente contenuti rispetto ai benefici. Esaminiamoli nel dettaglio.
...
Non esiste una singola grande organizzazione medica al mondo che classifichi la transizione medica come "sperimentale" o "pericolosa". Il consenso scientifico non è un'opinione: è il risultato di decenni di ricerca accumulata.

## La transizione non è sperimentale
...
La definizione di "sperimentale" ha un significato preciso in medicina: si riferisce a trattamenti in fase di studio clinico, non ancora approvati per l'uso nella pratica corrente. La terapia ormonale per le persone trans non rientra in questa definizione. È prevista nelle linee guida cliniche, raccomandata dalle società scientifiche, coperta dai sistemi sanitari di decine di paesi.
...
- **Profilo lipidico e glicemia** per il rischio cardiovascolare
- **Funzionalità epatica** nei primi mesi e periodicamente
- **Densitometria ossea** periodica, soprattutto dopo gonadectomia
- **Screening oncologici** appropriati (mammografia, screening prostatico) in base alla storia clinica individuale

Questo monitoraggio non è diverso, nella sostanza, da quello richiesto per qualsiasi terapia ormonale a lungo termine: contraccettivi orali, terapia ormonale sostitutiva in menopausa, terapia con testosterone per l'ipogonadismo maschile. La differenza è che per la transizione medica il monitoraggio viene presentato come prova di "pericolosità", mentre per gli altri trattamenti viene considerato normale pratica clinica.

## Perché alcune narrazioni esagerano i rischi

La percezione pubblica della sicurezza della transizione medica è distorta da diversi fattori.

**Amplificazione selettiva delle storie negative.** I media tendono a dare spazio alle storie di rimpianto e complicazioni, mentre i milioni di percorsi positivi non fanno notizia. Questo crea una percezione distorta della frequenza degli esiti negativi.
...
## Una nota sulla qualità delle evidenze
