---
lang: "it"
translationKey: "fertilita-persone-trans"
...
sources:
  ...
  - title: "Successful restoration of spermatogenesis following gender-affirming hormone therapy in transgender women"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9873819/"
    year: 2023
  - title: "Reproductive wish in transsexual men"
    url: "https://academic.oup.com/humrep/article/27/2/483/2919320"
    year: 2012
  - title: "Access to fertility services by transgender and nonbinary persons: an Ethics Committee opinion"
    url: "https://www.asrm.org/practice-guidance/ethics-opinions/access-to-fertility-services-by-transgender-and-nonbinary-persons-an-ethics-committee-opinion-2021/"
    year: 2021
  - title: "Impact of Exogenous Testosterone on Reproduction in Transgender Men"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC7046016/"
    year: 2020
  - title: "The effect of estrogen therapy on spermatogenesis in transgender women"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC8441557/"
    year: 2021
  - title: "Factors affecting fertility decision-making among transgender adolescents and young adults"
    url: "https://pubmed.ncbi.nlm.nih.gov/30724132/"
    year: 2019
  ...
  - title: "Fertility Preservation and Reproductive Potential in Transgender and Gender Fluid Population"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9496568/"
    year: 2022
  - title: "Preservazione della fertilità e percorso di affermazione di genere - Infotrans.it"
    url: "https://www.infotrans.it/it-schede-43-preservazione_fertilita_transgender"
    year: 2024
  - title: "Corte costituzionale - sentenza n. 155/2025: Genitorialità delle persone transgender e preservazione della fertilità"
    url: "https://www.biodiritto.org/Biolaw-pedia/Giurisprudenza/Corte-costituzionale-sentenza-n.-155-2025-Genitorialita-delle-persone-transgender-e-preservazione-della-fertilita"
    year: 2025
faq:
  - question: "Le persone trans possono avere figli?"
    answer: "Sì. Le persone trans possono avere figli biologici attraverso la preservazione della fertilità prima della terapia ormonale, oppure attraverso adozione e PMA. Alcuni uomini trans hanno portato avanti gravidanze anche dopo periodi di terapia con testosterone."
  - question: "La terapia ormonale rende sterili?"
    answer: "La terapia ormonale riduce la fertilità ma non sempre in modo permanente. Gli estrogeni riducono la spermatogenesi, il testosterone interrompe l'ovulazione. In alcuni casi la fertilità può tornare dopo la sospensione, ma non è garantito."
  - question: "Come preservare la fertilità prima della transizione?"
    answer: "Le donne trans possono congelare spermatozoi (crioconservazione del seme). Gli uomini trans possono congelare ovociti o tessuto ovarico. Queste procedure vanno fatte idealmente prima dell'inizio della terapia ormonale."
  - question: "Un uomo trans può rimanere incinto?"
    answer: "Sì. Se un uomo trans conserva l'utero e le ovaie, può portare avanti una gravidanza, anche dopo un periodo di terapia con testosterone (sospendendola durante la gravidanza)."
related:
  - genitorialita-trans
...
Non tutte le persone decidono di preservare la fertilità prima di iniziare la terapia ormonale. Alcune non ricevono un'informazione adeguata in tempo, altre non si sentono pronte a prendere questa decisione, altre ancora cambiano idea nel corso del tempo. Anche in questi casi, esistono delle possibilità.
...
Il quadro normativo italiano presenta sfide significative per le persone trans che desiderano avere figli, sia attraverso la procreazione medicalmente assistita sia attraverso l'adozione.

### Procreazione medicalmente assistita (PMA)

La Legge 40/2004 regola la PMA in Italia e consente l'accesso esclusivamente a coppie di sesso diverso, sposate o conviventi. Questo significa che persone single e coppie dello stesso sesso sono escluse, indipendentemente dal loro status di persone transgender.

Una persona trans che ha completato la rettifica anagrafica e che si trova in una coppia di sesso diverso (ad esempio, un uomo trans con un partner maschile cisgender, entrambi con documenti rettificati in modo da risultare una coppia eterosessuale) può formalmente accedere alla PMA. Nella pratica, tuttavia, l'accesso resta complicato da interpretazioni restrittive e dalla mancanza di protocolli specifici.
...
L'adozione in Italia è regolata dalla Legge 184/1983, che prevede l'adozione piena solo per coppie sposate. Una persona trans che ha completato la rettifica anagrafica e che si trova in un matrimonio eterosessuale può teoricamente accedere all'adozione. Nella pratica, il percorso è spesso ostacolato da pregiudizi culturali e dalla discrezionalità dei tribunali dei minori nella valutazione dell'idoneità genitoriale.

La cosiddetta adozione in casi particolari (articolo 44 della Legge 184/1983) rappresenta una possibilità più accessibile, ma offre tutele giuridiche più limitate rispetto all'adozione piena. L'accesso all'adozione per le persone transgender rimane un tema largamente assente dal dibattito politico italiano.

## Costi e accessibilità in Italia

I costi della preservazione della fertilità in Italia variano considerevolmente in base alla tecnica utilizzata e alla struttura scelta.

### Crioconservazione del liquido seminale

Il costo iniziale si aggira tra i 300 e gli 800 euro, a cui si aggiunge un canone annuale di mantenimento che varia tra i 100 e i 300 euro. È la procedura più economica e meno invasiva tra tutte le opzioni disponibili.

### Crioconservazione di ovociti

Il percorso completo, che include la stimolazione ovarica, il monitoraggio ecografico, il prelievo ovocitario in sedazione e la crioconservazione, costa indicativamente tra i 1.500 e i 7.000 euro, a seconda del centro. Anche in questo caso si aggiunge un costo annuale per il mantenimento.

### Novità 2025: i LEA

Un cambiamento significativo è rappresentato dall'inclusione della PMA nei Livelli Essenziali di Assistenza (LEA) nel 2025. Le prestazioni legate alla PMA, inclusa la crioconservazione di ovociti per scopi di preservazione della fertilità, possono ora essere erogate a carico del Servizio Sanitario Nazionale, con un contributo del paziente sotto forma di ticket generalmente contenuto tra i 100 e i 300 euro. Tuttavia, non tutti i centri pubblici hanno ancora attivato questi servizi, e la copertura varia da regione a regione.

### Detraibilità fiscale

Dal 2024, le spese per la crioconservazione degli ovociti sono detraibili al 19% nella dichiarazione dei redditi (modello 730), un'ulteriore agevolazione che rende la preservazione della fertilità più accessibile dal punto di vista economico.
...
Le decisioni sulla fertilità si intrecciano profondamente con l'identità, il benessere psicologico e il progetto di vita delle persone trans. Diversi studi hanno esplorato la complessità emotiva di queste scelte.
...
**Cerca supporto psicologico** se la decisione ti crea ansia o conflitto. Un professionista esperto può aiutarti a esplorare i tuoi desideri e le tue paure senza giudizio.

## In sintesi

Le persone trans possono avere figli. Le opzioni includono la preservazione della fertilità prima della terapia ormonale, la sospensione temporanea della terapia per recuperare la capacità riproduttiva, la gravidanza diretta (per gli uomini trans che conservano utero e ovaie), l'adozione e la PMA. Il quadro legale italiano presenta ancora ostacoli significativi, ma la scienza e la giurisprudenza si stanno muovendo nella direzione di un maggiore riconoscimento dei diritti riproduttivi delle persone transgender.

La cosa più importante è ricevere informazioni complete e tempestive, idealmente prima di iniziare qualsiasi terapia, per poter fare scelte consapevoli che rispettino i propri desideri di vita.
