---
lang: "it"
translationKey: "che-cose-il-genere"
...
sources:
  - title: "WHO - Gender and health"
    ...
    year: 2024
  - title: "APA - Understanding Transgender People, Gender Identity and Gender Expression"
    url: "https://www.apa.org/topics/lgbtq/transgender-people-gender-identity-gender-expression"
    year: 2024
  ...
  - title: "Gender trouble: Feminism and the subversion of identity - Judith Butler"
    ...
    year: 1990
  - title: "The Role of Gender in Society - Robert Stoller, Sex and Gender (1968)"
    url: "https://en.wikipedia.org/wiki/Robert_Stoller"
    year: 1968
  - title: "Doing Gender - West & Zimmerman, Gender & Society"
    url: "https://www.jstor.org/stable/189945"
    year: 1987
  - title: "Sex beyond the genitalia: The human brain mosaic - PNAS"
    url: "https://www.pnas.org/doi/10.1073/pnas.1509654112"
    year: 2015
  - title: "The Gender Similarities Hypothesis - Janet Shibley Hyde, American Psychologist"
    url: "https://pubmed.ncbi.nlm.nih.gov/16173891/"
    year: 2005
  - title: "Non-binary or genderqueer genders - International Review of Psychiatry"
    url: "https://pubmed.ncbi.nlm.nih.gov/26753630/"
    year: 2016
  - title: "Neurobiology of gender identity and sexual orientation - Journal of Neuroendocrinology"
  ...
  - title: "Standards of Care for the Health of Transgender and Gender Diverse People, Version 8 - WPATH"
    ...
    year: 2022
  - title: "Sex redefined: the idea of 2 sexes is overly simplistic - Nature"
    url: "https://www.nature.com/articles/518288a"
    year: 2015
  - title: "Third gender - Wikipedia (panoramica storica e culturale)"
    url: "https://en.wikipedia.org/wiki/Third_gender"
    year: 2025
  - title: "Margaret Mead - Sex and Temperament in Three Primitive Societies"
    url: "https://en.wikipedia.org/wiki/Sex_and_Temperament_in_Three_Primitive_Societies"
    year: 1935
faq:
  - question: "Qual è la differenza tra sesso e genere?"
    answer: "Il sesso si riferisce alle caratteristiche biologiche (cromosomi, ormoni, anatomia), mentre il genere è un costrutto più ampio che comprende identità di genere, espressione di genere e ruoli di genere, ed è il prodotto dell'interazione tra fattori biologici, psicologici e culturali."
  - question: "Il genere è una costruzione sociale?"
    answer: "Il genere ha sia una componente biologica sia una componente sociale. L'identità di genere ha basi neurobiologiche documentate dalla ricerca, ma i ruoli e le aspettative di genere variano enormemente tra culture e periodi storici, dimostrando la loro natura costruita socialmente."
  - question: "Quanti generi esistono?"
    answer: "Non esiste un numero fisso di generi. Le principali istituzioni scientifiche (WHO, APA) riconoscono che il genere è uno spettro e che le identità possibili vanno oltre il binarismo uomo-donna. Molte culture nel mondo riconoscono da secoli identità di genere al di fuori delle due categorie tradizionali."
  - question: "Il genere è determinato alla nascita?"
    answer: "Alla nascita viene assegnato un sesso in base alle caratteristiche fisiche osservabili. L'identità di genere, tuttavia, è un'esperienza interiore che si manifesta tipicamente nella prima infanzia e che può corrispondere o meno al sesso assegnato, come riconosciuto dall'OMS e dall'APA."
related:
  - identita-di-genere
  - sesso-biologico-oltre-il-binarismo
  - che-cose-il-sesso-biologico
  - persone-non-binarie
---

Il **genere** è uno dei concetti più fondamentali -- e allo stesso tempo più fraintesi -- dell'esperienza umana. Spesso confuso con il sesso biologico, il genere è in realtà un concetto molto più ampio e articolato, che comprende l'identità interiore, il modo in cui ci presentiamo al mondo e le aspettative che la società attribuisce alle diverse categorie. Comprendere cosa sia il genere, come si distingua dal sesso, come si sia evoluto storicamente e cosa la scienza moderna ci dice al riguardo è essenziale per orientarsi con consapevolezza nel dibattito contemporaneo su identità, diritti e inclusione.

## Genere e sesso: una distinzione necessaria

La distinzione tra **sesso** e **genere** è il punto di partenza per qualsiasi discussione informata sull'argomento. Nel linguaggio quotidiano i due termini vengono spesso usati come sinonimi, ma in ambito scientifico, medico e psicologico descrivono realtà diverse.
...
## Le tre dimensioni del genere

Il genere non è un concetto monolitico. Si articola in almeno tre dimensioni distinte, che possono variare in modo indipendente l'una dall'altra.
...
L'**espressione di genere** riguarda il modo in cui una persona comunica il proprio genere al mondo esterno: l'abbigliamento, il taglio di capelli, il linguaggio corporeo, la voce, il modo di muoversi nello spazio. L'espressione di genere può essere descritta come più maschile, più femminile, androgina o in qualsiasi altra combinazione.

Un aspetto cruciale dell'espressione di genere è che essa è in larga misura modellata dalle norme culturali. Ciò che viene considerato "maschile" o "femminile" nell'abbigliamento, nel portamento o nel comportamento varia enormemente tra le culture e i periodi storici. I tacchi alti, oggi associati alla femminilità nella cultura occidentale, erano indossati dagli uomini aristocratici europei nel XVII secolo. Il rosa, oggi spesso associato alle bambine, era considerato un colore maschile fino alla metà del XX secolo. Questi esempi dimostrano che l'espressione di genere non è un riflesso diretto della biologia, ma il prodotto di convenzioni sociali in continua evoluzione.

È importante sottolineare che l'espressione di genere di una persona non corrisponde necessariamente alla sua identità di genere. Un uomo cisgender può avere un'espressione di genere femminile senza che questo metta in discussione la sua identità. Allo stesso modo, una donna transgender non ha bisogno di adottare un'espressione di genere iperfemminile perché la sua identità sia valida.
...
## Breve storia del concetto di genere

Il concetto di genere come distinto dal sesso biologico ha una storia relativamente recente nella cultura occidentale, anche se le realtà che descrive sono antiche quanto l'umanità.

### Le origini: da Simone de Beauvoir a John Money

La frase più celebre nella storia degli studi di genere è probabilmente quella di **Simone de Beauvoir** nel *Secondo sesso* (1949): "Donna non si nasce, lo si diventa." Con questa affermazione, de Beauvoir apriva la strada all'idea che la femminilità (e, per estensione, la mascolinità) non fosse un dato naturale, ma il prodotto di un processo di socializzazione.

Il termine "genere" (*gender*) nel suo significato moderno fu introdotto in ambito scientifico dallo psicologo e sessuologo **John Money** negli anni Cinquanta, per descrivere i comportamenti e le caratteristiche psicologiche associate alla mascolinità e alla femminilità, distinguendoli dal sesso biologico. Money propose il concetto di **ruolo di genere** (*gender role*) per indicare tutto ciò che una persona fa per rivelare la propria condizione di maschio o femmina.
...
La comprensione scientifica del genere si è evoluta significativamente negli ultimi decenni, integrando evidenze provenienti dalla psicologia, dalle neuroscienze, dalla genetica e dalla sociologia.
...
Il genere non è un concetto astratto confinato nei libri di testo: è una forza che plasma la vita quotidiana di ogni persona, spesso in modi così pervasivi da risultare invisibili.

### Socializzazione di genere

Fin dalla nascita -- e talvolta ancor prima, con le feste di *gender reveal* -- le persone sono immerse in un sistema di aspettative legate al genere. Il colore della cameretta, i giocattoli, i vestiti, il modo in cui gli adulti parlano ai bambini e alle bambine, le attività sportive incoraggiate: tutto contribuisce a un processo di **socializzazione di genere** attraverso il quale le persone apprendono cosa significhi essere "maschio" o "femmina" nella propria cultura.

Questo processo non è neutro. La ricerca ha dimostrato che adulti inconsapevoli trattano diversamente neonati identici a seconda che venga detto loro che il bambino è maschio o femmina: parlano in modo più dolce con le presunte femmine, incoraggiano più attività fisica con i presunti maschi. Queste differenze, minime all'inizio, si accumulano nel tempo e contribuiscono a creare le differenze di genere che poi vengono percepite come "naturali".

### Stereotipi e aspettative

Gli **stereotipi di genere** sono generalizzazioni rigide sulle caratteristiche, i comportamenti e i ruoli appropriati per uomini e donne. Alcuni esempi comuni: gli uomini "non piangono", le donne sono "naturalmente" più empatiche, gli uomini sono "portati" per la matematica, le donne per le attività di cura. Questi stereotipi, pur contenendo talvolta un fondo statistico, hanno l'effetto di limitare le possibilità di tutte le persone -- non solo di quelle transgender o non binarie -- costringendole in categorie rigide che non rispecchiano la complessità delle esperienze individuali.

### Il genere come struttura sociale

Il genere funziona anche come una **struttura sociale** che organizza le relazioni di potere, l'accesso alle risorse e le opportunità. Le disuguaglianze di genere -- nel lavoro, nella politica, nella distribuzione del lavoro di cura, nella violenza -- non sono il prodotto inevitabile delle differenze biologiche, ma il risultato di sistemi sociali che attribuiscono valore e potere diversi alle diverse posizioni di genere. Comprendere il genere come costruzione sociale non significa negarne la realtà, ma riconoscere che le sue forme specifiche sono il prodotto di scelte collettive e, in quanto tali, possono essere trasformate.

## Oltre il binarismo: lo spettro di genere
...
Comprendere il genere è importante per diverse ragioni che vanno oltre il dibattito accademico.

In primo luogo, una comprensione accurata del genere è essenziale per la **salute e il benessere** delle persone transgender e non binarie. La ricerca mostra che il disagio psicologico sperimentato da molte persone transgender non è causato dalla loro identità di genere, ma dallo stigma, dalla discriminazione e dalla mancanza di riconoscimento sociale. Comprendere che il genere è uno spettro e che le identità non conformi sono varianti naturali dell'esperienza umana contribuisce a ridurre questo stigma.

In secondo luogo, comprendere il genere aiuta tutte le persone -- non solo quelle transgender -- a riconoscere e mettere in discussione gli **stereotipi** che limitano le loro possibilità. Un ragazzo che ama la danza, una ragazza appassionata di meccanica, un padre che sceglie di dedicarsi alla cura dei figli: tutte queste persone beneficiano di una società che non impone ruoli rigidi in base al genere.

Infine, la comprensione del genere è un prerequisito per costruire una **società più giusta**. Le disuguaglianze di genere -- dal divario salariale alla violenza di genere, dalla sottorappresentazione politica alla distribuzione iniqua del lavoro di cura -- non possono essere affrontate senza comprendere i meccanismi attraverso i quali il genere viene costruito, riprodotto e naturalizzato.

Il genere è una realtà complessa che attraversa la biologia, la psicologia, la cultura e la struttura sociale. Non è riducibile né al corpo né alla società, ma emerge dall'interazione tra queste dimensioni. Riconoscere questa complessità non è un atto ideologico, ma un atto di comprensione -- della scienza, della storia e, in definitiva, della varietà irriducibile dell'esperienza umana.
