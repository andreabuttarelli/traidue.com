...
sources:
  ...
  - title: "Infotrans - Il trattamento ormonale di affermazione di genere"
    ...
    year: 2024
  - title: "Infotrans - Il trattamento chirurgico di affermazione di genere"
  ...
  - title: "AIFA - Farmaci ormonali per le transizioni di genere erogabili a carico del SSN (Determine 104272/2020 e 104273/2020)"
    ...
    year: 2020
  - title: "Il Sole 24 Ore - Viaggio nelle disuguaglianze della sanità: per le persone transgender liste d'attesa fino a 7 anni"
    url: "https://www.ilsole24ore.com/art/viaggio-disuguaglianze-sanita-le-persone-transgender-liste-d-attesa-fino-7-anni-AGaEINrD"
    year: 2024
  - title: "TGEU - Trans Health Map 2024: The State of Trans Healthcare in the EU"
    url: "https://www.tgeu.org/trans-health-map-2024-as-who-guidelines-approach-healthcare-for-trans-people-in-the-eu-still-hindered-by-stigma-and-long-delays/"
    year: 2024
  - title: "SIMG - Indagine sull'accesso della popolazione transgender alle cure"
    url: "https://www.simg.it/Riviste/rivista_simg/2024/03_2024/9.pdf"
    year: 2024
  - title: "WPATH Standards of Care for the Health of Transgender and Gender Diverse People, Version 8"
    ...
    year: 2022
  - title: "Ministero della Salute - Livelli essenziali di assistenza (LEA) - DPCM 12 gennaio 2017"
    url: "https://www.salute.gov.it/new/it/tema/livelli-essenziali-di-assistenza/il-dpcm-del-2017-e-gli-allegati/"
    year: 2017
  - title: "Giuricivile - Diritto alla salute delle persone transgender: evoluzione giuridica, criticità e prospettive normative"
    url: "https://giuricivile.it/il-diritto-alla-salute-delle-persone-transgender-evoluzione-giuridica-criticita-e-prospettive-normative/"
    year: 2024
  - title: "TGEU - Trans* people's access to gender-affirming health care: A European comparison"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC9593523/"
    year: 2022
  - title: "ISS - Comunicato Stampa: Salute di genere, basso livello di prevenzione nella popolazione transgender"
    ...
    year: 2022
faq:
  - question: "Le cure per la transizione sono coperte dal SSN in Italia?"
    answer: "Sì, in gran parte. La terapia ormonale è gratuita dal 2020 grazie alle determine AIFA. Le visite specialistiche e gli esami sono soggetti ai normali ticket. Gli interventi chirurgici sono eseguibili in regime SSN, ma le liste di attesa possono essere molto lunghe (fino a 5-7 anni per la chirurgia)."
  - question: "Quanto si aspetta per accedere a un centro per l'identità di genere?"
    answer: "I tempi di attesa variano enormemente in base al centro e alla regione. Per il primo colloquio si va da 1-2 mesi nei centri meno congestionati a 6-12 mesi nei centri principali come Roma o Torino. Per la chirurgia, le attese arrivano fino a 5-7 anni."
  - question: "Serve una diagnosi psichiatrica per accedere alla terapia ormonale in Italia?"
    answer: "Serve una relazione psicodiagnostica che attesti l'incongruenza di genere, redatta da uno psicologo o psicoterapeuta specializzato, spesso all'interno di un'équipe multidisciplinare. Non è una diagnosi psichiatrica nel senso tradizionale: l'incongruenza di genere non è classificata come disturbo mentale dall'OMS dal 2019."
  - question: "Posso curarmi privatamente e poi passare al SSN?"
    answer: "Sì, ed è una strategia molto comune. Molte persone iniziano il percorso psicologico privatamente per accorciare i tempi, e poi accedono al SSN per la terapia ormonale (gratuita con prescrizione) e per gli eventuali interventi chirurgici."
related:
...
3. **Redigere la documentazione** necessaria per la prescrizione ormonale e, successivamente, per la [rettificazione anagrafica](/wiki/legge-164-italia).
...
- **Tempi della giustizia**: il percorso di [rettificazione anagrafica](/wiki/legge-164-italia) richiede una sentenza del tribunale, e i tempi della giustizia civile variano enormemente tra regioni. Un procedimento che a Torino si conclude in 6-8 mesi può richiedere oltre 2 anni in tribunali con maggiore arretrato.
...
Consultare la [mappa di Infotrans.it](https://www.infotrans.it/it-schede-3-mappa_servizi_transgender) e il [sito ONIG](https://www.onig.it/i-centri-italiani/) per identificare il centro più vicino [4][5]. Verificare quali servizi offre, i tempi di attesa stimati e le modalità di accesso (con o senza impegnativa del medico di base).
...
Con la documentazione del percorso (relazione psicologica, documentazione endocrinologica), si può avviare il procedimento di [rettificazione anagrafica](/wiki/cambio-documenti-trans) presso il tribunale del luogo di residenza, assistiti da un avvocato.

## Il portale Infotrans: una risorsa istituzionale

Il portale [Infotrans.it](https://www.infotrans.it/) merita una menzione specifica. Realizzato dall'Istituto Superiore di Sanità in collaborazione con l'UNAR (Ufficio Nazionale Antidiscriminazioni Razziali), è il primo portale istituzionale in Europa interamente dedicato alla salute e al benessere delle persone trans [4]. Offre:
