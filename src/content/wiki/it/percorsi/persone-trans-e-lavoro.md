---
lang: "it"
translationKey: "persone-trans-e-lavoro"
...
sources:
  ...
  - title: "FRA – EU LGBTIQ Survey III: LGBTIQ equality at a crossroads"
    ...
    year: 2024
  - title: "Direttiva 2006/54/CE – Parità di trattamento fra uomini e donne in materia di occupazione e impiego"
    url: "https://eur-lex.europa.eu/legal-content/IT/TXT/PDF/?uri=CELEX:32006L0054"
    year: 2006
  - title: "D.lgs. 9 luglio 2003, n. 216 – Attuazione della direttiva 2000/78/CE per la parità di trattamento in materia di occupazione"
    url: "https://www.normattiva.it/uri-res/N2Ls?urn%3Anir%3Astato%3Adecreto.legislativo%3A2003-07-09%3B216="
    year: 2003
  - title: "D.lgs. 25 gennaio 2010, n. 5 – Attuazione della direttiva 2006/54/CE (parità uomini e donne nel lavoro)"
    url: "https://www.gazzettaufficiale.it/eli/id/2010/02/05/010G0018/sg"
    year: 2010
  - title: "Corte di Giustizia UE – P. c. S. e Cornwall County Council, Causa C-13/94 (discriminazione per cambio di sesso)"
    url: "https://eur-lex.europa.eu/legal-content/IT/TXT/HTML/?uri=CELEX:61994CJ0013"
    year: 1996
  - title: "Inclusion4All – Persone trans, intersex e non binarie a lavoro in Italia: rapporto nazionale"
    ...
    year: 2022
  - title: "Strategia Nazionale LGBT+ 2022-2025 – UNAR"
    url: "https://unar.it/portale/strategia-nazionale-lgbt-2022-2025"
    year: 2022
  - title: "UNAR – Segnalare una discriminazione (Contact Center)"
    url: "https://www.unar.it/portale/segnalare-una-discriminazione"
    year: 2024
  - title: "Rete Lenford – Discriminazione sul lavoro (temi LGBTI)"
    url: "https://www.retelenford.it/temi/discriminazione-in-ambito-lavorativo/"
    year: 2024
  - title: "Parks – Liberi e Uguali: LGBT+ Diversity Index"
    url: "https://www.parksdiversity.eu/en/the-lgbt-diversity-index/"
    year: 2024
  ...
  - title: "Gazzetta Ufficiale – Legge 14 aprile 1982, n. 164"
    ...
    year: 1982
faq:
  - question: "Le persone trans possono lavorare liberamente in Italia?"
    answer: "Legalmente sì. La discriminazione sul lavoro basata sull'identità di genere è vietata dalla normativa europea e italiana. Tuttavia, nella pratica la discriminazione è diffusa: i dati mostrano tassi di disoccupazione molto più alti rispetto alla popolazione generale."
  - question: "Posso essere licenziato perché sono trans?"
    answer: "No. Il licenziamento discriminatorio basato sull'identità di genere è illegale in Italia, protetto dalla Direttiva 2006/54/CE e dalla giurisprudenza della Corte di Giustizia UE. Puoi fare ricorso al tribunale del lavoro."
  - question: "Devo dire al datore di lavoro che sono trans?"
    answer: "No. Non esiste alcun obbligo legale. Dopo la rettificazione anagrafica, i tuoi documenti riflettono il genere corretto e il datore di lavoro non ha diritto di conoscere la tua storia medica."
  - question: "Come gestire la transizione sul posto di lavoro?"
    answer: "Molte aziende hanno protocolli di inclusione. Se non esistono, è utile coinvolgere HR e definire un piano (comunicazione ai colleghi, uso del nome, accesso ai servizi). Associazioni come Arcigay o il MIT possono offrire supporto."
related:
...
## Gestire la transizione sul posto di lavoro

### Comunicazione e pianificazione

Per chi inizia o prosegue il percorso di transizione mentre è già occupato, la gestione della comunicazione sul luogo di lavoro è una questione delicata ma affrontabile. Non esiste un unico modo corretto di procedere: la scelta dipende dal contesto aziendale, dal livello di sicurezza percepito e dalle preferenze personali.

Se l'azienda dispone di un ufficio risorse umane strutturato, un primo passo utile è il **colloquio con HR**. In questa sede si possono definire: le modalità di comunicazione ai colleghi (chi lo farà, quando, come), i tempi di transizione nel nome e nei pronomi utilizzati, l'aggiornamento di email, badge e documenti interni, l'accesso ai servizi igienici coerenti con la propria identità di genere.

### L'identità alias in ambito lavorativo

Anche prima della rettificazione anagrafica, alcune aziende e amministrazioni pubbliche hanno adottato politiche di **identità alias** che consentono ai dipendenti transgender di utilizzare il nome elettivo nelle comunicazioni interne, nelle email aziendali e nei badge identificativi. Nel settembre 2024, il **Ministero della Giustizia** ha emanato una circolare per l'attivazione dell'identità alias per i dipendenti dell'Amministrazione giudiziaria, segnando un precedente importante nel settore pubblico.

L'alias non ha valore legale: i documenti contrattuali e fiscali continuano a riportare il nome anagrafico fino alla rettificazione giudiziaria. Tuttavia, l'utilizzo del nome elettivo nelle interazioni quotidiane, nelle email e negli spazi condivisi riduce significativamente il disagio e il rischio di outing non consensuale.

### Servizi igienici e codice di abbigliamento

L'accesso ai servizi igienici coerenti con la propria identità di genere è un tema pratico che emerge frequentemente. Non esiste una norma italiana che vieti a una persona trans di utilizzare il bagno corrispondente al proprio genere. Le linee guida delle organizzazioni internazionali raccomandano che le persone transgender abbiano accesso ai servizi igienici coerenti con la propria identità di genere, non con il sesso assegnato alla nascita.

Per quanto riguarda il codice di abbigliamento, un datore di lavoro che imponga a una persona trans un dress code non coerente con la sua identità di genere commette una discriminazione diretta. Se l'azienda prevede divise differenziate per genere, la persona trans ha diritto a indossare quella corrispondente alla propria identità.

## Discriminazione: come riconoscerla e come agire

### Forme di discriminazione lavorativa
...
**Organizzazioni sindacali**. I sindacati possono assistere i lavoratori nelle vertenze per discriminazione e nelle procedure di conciliazione. Alcune organizzazioni sindacali hanno sviluppato sportelli specifici per le tematiche LGBTI+.

## Aziende inclusive: il panorama italiano
...
Se stai cercando lavoro o affrontando una situazione difficile sul posto di lavoro, ecco alcuni passi pratici.

**Documenta tutto.** Conserva email, messaggi, appunti con data e ora di episodi discriminatori. La documentazione è fondamentale per qualsiasi azione legale o segnalazione.

**Conosci i tuoi diritti.** La discriminazione lavorativa basata sull'identità di genere è illegale. Non sei tenuta o tenuto a giustificare chi sei, a rivelare la tua storia di transizione o ad accettare un trattamento sfavorevole.
