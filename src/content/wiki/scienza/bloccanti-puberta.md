...
sources:
  - title: "Endocrine Treatment of Gender-Dysphoric/Gender-Incongruent Persons: An Endocrine Society Clinical Practice Guideline"
    url: "https://pubmed.ncbi.nlm.nih.gov/28945902/"
    year: 2017
  ...
  - title: "Ensuring Comprehensive Care and Support for Transgender and Gender-Diverse Children and Adolescents (AAP)"
    ...
    year: 2018
  - title: "Young adult psychological outcome after puberty suppression and gender reassignment (de Vries et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/25201798/"
    year: 2014
  - title: "Pubertal Suppression for Transgender Youth and Risk of Suicidal Ideation (Turban et al.)"
  ...
  - title: "Mental Health Outcomes in Transgender and Nonbinary Youths Receiving Gender-Affirming Care (Tordoff et al.)"
    ...
    year: 2022
  - title: "Bone Mineral Density in Transgender Adolescents Treated With Puberty Suppression and Subsequent Gender-Affirming Hormones (van der Loos et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/37902760/"
    year: 2023
  - title: "The effect of GnRH analogue treatment on bone mineral density in young adolescents with gender dysphoria (Joseph et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/31472062/"
    year: 2019
  - title: "The Cass Review — Independent Review of Gender Identity Services for Children and Young People: Final Report"
    ...
    year: 2024
  - title: "Determina AIFA n. 21756/2019 — Inserimento della triptorelina nell'elenco dei medicinali erogabili a totale carico del SSN"
    url: "https://www.gazzettaufficiale.it/eli/id/2019/03/02/19A01426/SG"
    year: 2019
  - title: "DDL 2575 — Disposizioni per l'appropriatezza prescrittiva e il corretto utilizzo dei farmaci per la disforia di genere"
  ...
  - title: "Il Post — Il governo vuole controllare di più le terapie farmacologiche per preadolescenti e adolescenti trans"
    ...
    year: 2025
  - title: "Puberty suppression in adolescents with gender identity disorder: a prospective follow-up study (de Vries et al.)"
    url: "https://pubmed.ncbi.nlm.nih.gov/20646177/"
    year: 2011
  - title: "Puberty Blockers for Transgender and Gender-Diverse Youth (Mayo Clinic)"
...
faq:
  - question: "Cosa sono i bloccanti della pubertà?"
    answer: "Sono farmaci (agonisti del GnRH, come la triptorelina) che sospendono temporaneamente lo sviluppo puberale. Sono usati da decenni in pediatria per la pubertà precoce e, più recentemente, anche per la disforia di genere nei minori."
  - question: "I bloccanti della pubertà sono reversibili?"
    answer: "Alla sospensione del trattamento la pubertà riprende il suo corso. Le principali linee guida internazionali (WPATH, Endocrine Society) li classificano come intervento reversibile, a differenza della terapia ormonale cross-sex che produce cambiamenti permanenti."
  - question: "Quali sono gli effetti collaterali?"
...
Nel complesso, la letteratura disponibile suggerisce un'associazione tra soppressione puberale e miglioramento degli esiti di [salute mentale](/wiki/salute-mentale-persone-trans), ma la qualità dell'evidenza -- come riconosciuto dalla stessa comunità scientifica -- rimane moderata, con studi prevalentemente osservazionali, campioni ridotti e assenza di trial randomizzati controllati.
...
Il **4 agosto 2025**, il Consiglio dei Ministri ha approvato il [DDL 2575](/wiki/ddl-disforia), su proposta del Ministro della Salute **Orazio Schillaci** e della Ministra per la Famiglia **Eugenia Roccella** [11][12]. Il disegno di legge introduce tre articoli principali che modificano il quadro normativo per la prescrizione di bloccanti della pubertà e ormoni ai minori con disforia di genere:
