---
title: "Adolescenti transgender in Italia"
seoTitle: "Giovani trans in Italia: esperienze, sfide e risorse"
...
sources:
  ...
  - title: "Mental Health and Self-Worth in Socially Transitioned Transgender Youth"
    ...
    year: 2017
  - title: "Social Media Use and Its Connection to Mental Health: A Systematic Review - Cureus"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC10334840/"
    year: 2023
faq:
  - question: "Quanti adolescenti trans ci sono in Italia?"
    answer: "Non esistono dati ufficiali precisi. Stime internazionali indicano che circa lo 0,5-2% degli adolescenti si identifica come transgender o gender-diverse. I centri italiani per l'identità di genere riportano un aumento costante delle richieste da parte di minori negli ultimi anni, in linea con la tendenza globale legata a una maggiore consapevolezza."
  - question: "Un adolescente può iniziare una transizione medica in Italia?"
    answer: "In Italia, i minori possono accedere a un percorso di supporto psicologico e, dopo valutazione multidisciplinare, ai bloccanti della pubertà. La terapia ormonale sostitutiva viene generalmente considerata a partire dai 16 anni, con il consenso dei genitori e del team clinico. Ogni caso è valutato individualmente dai centri specializzati."
  - question: "La carriera alias è disponibile in tutte le scuole italiane?"
    answer: "No, non esiste un obbligo nazionale. Al 2025, oltre 480 scuole e 32 università pubbliche italiane prevedono la carriera alias nel proprio regolamento. L'adozione dipende dalla singola scuola e dalle iniziative locali."
  - question: "Come posso aiutare un amico o un compagno di classe trans?"
    answer: "Usa il nome e i pronomi che preferisce, trattalo come tratteresti qualsiasi altro amico, non fare domande invadenti sulla sua transizione e intervieni se senti commenti transfobici. Il supporto dei coetanei è uno dei fattori protettivi più forti per la salute mentale dei giovani trans."
related:
  - bambini-trans
  - sono-trans
...
L'[identità di genere](/wiki/identita-di-genere) non ha un timer. Alcune persone lo sanno fin dall'infanzia -- studi longitudinali mostrano che i [bambini trans](/wiki/bambini-trans) esprimono la propria identità con la stessa coerenza e stabilità dei coetanei cisgender. Altre lo capiscono durante la pubertà, quando il corpo inizia a cambiare in una direzione che sentono profondamente sbagliata. Altre ancora se ne rendono conto più tardi, a diciotto, a venticinque, a quarant'anni.

Per gli adolescenti, la pubertà è spesso il momento critico. Il corpo si trasforma in modi che possono amplificare la [disforia di genere](/wiki/disforia-di-genere): lo sviluppo del seno, la crescita della barba, il cambio della voce, le mestruazioni. Cambiamenti che per un adolescente cisgender sono normali tappe della crescita possono diventare, per un adolescente trans, fonte di un disagio profondo e persistente.

### La differenza tra esplorazione e identità

Non tutti gli adolescenti che si interrogano sulla propria identità di genere sono transgender -- e va bene così. L'[esplorazione dell'identità](/wiki/esplorare-identita-di-genere) fa parte dello sviluppo adolescenziale. La differenza sta nella **persistenza, insistenza e coerenza** dell'esperienza: un adolescente trans non attraversa una curiosità passeggera, ma vive un senso di incongruenza profonda tra chi è e come viene percepito.
...
I dati sulla [salute mentale](/wiki/salute-mentale-persone-trans) dei giovani trans sono preoccupanti, ma vanno letti con attenzione. Il Trevor Project (2024) riporta che il **46% dei giovani transgender e non binari** ha considerato seriamente il suicidio nell'ultimo anno [1]. Il dato è allarmante, ma la ricerca mostra con chiarezza che la causa non è l'essere trans in sé: è il modo in cui la società tratta le persone trans.
...
1. **Valutazione psicologica** da parte di un team multidisciplinare
2. **Supporto psicologico** durante l'esplorazione dell'identità
3. **Bloccanti della pubertà** (agonisti del GnRH): farmaci reversibili che mettono in pausa lo sviluppo puberale, dando tempo al giovane di esplorare la propria identità senza la pressione di cambiamenti corporei irreversibili [4]
4. **Terapia ormonale sostitutiva**: generalmente considerata a partire dai 16 anni, con il consenso dei genitori e del team clinico [9]
...
Se sei un genitore e tuo figlio o tua figlia ti ha detto di essere trans, la guida [Cosa fare se tuo figlio è trans](/wiki/figlio-trans-cosa-fare) è pensata per te. Il messaggio più importante: non devi capire tutto subito. Devi far sentire a tuo figlio che è amato.
