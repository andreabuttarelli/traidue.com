---
title: "Persone trans e scuola in Italia"
seoTitle: "Come vivono le persone trans a scuola?"
slug: "trans-e-scuola"
...
sources:
  - title: "EU LGBTIQ Survey III — Results (FRA, European Union Agency for Fundamental Rights)"
    url: "https://fra.europa.eu/en/publication/2024/lgbtiq-equality-crossroads-progress-and-challenges"
    year: 2024
  - title: "GLSEN: Separation and Stigma — Transgender Youth and School Facilities"
    url: "https://www.glsen.org/research/separation-and-stigma-transgender-youth-and-school-facilities"
    year: 2023
  - title: "GLSEN: Improving School Climate for Transgender and Nonbinary Youth"
    url: "https://www.glsen.org/research/improving-school-climate-transgender-and-nonbinary-youth"
    year: 2022
  - title: "Elenco scuole in Italia con Carriera Alias (AGEDO)"
    url: "https://www.agedonazionale.org/elenco-scuole-in-italia-con-carriera-alias/"
    year: 2025
  - title: "Carriera alias all'università: cos'è e come attivarla (Infotrans / ISS)"
    url: "https://www.infotrans.it/it-schede-48-carriera_alias_universita"
    year: 2023
  - title: "Discriminazione e bullismo nei confronti delle persone transgender (Infotrans / ISS)"
    url: "https://www.infotrans.it/it-schede-41-discriminazione_bullismo_persone_transgender"
    year: 2023
  - title: "Linee Guida Nazionali — Educare al rispetto (art. 1 comma 16 L. 107/2015, MIUR)"
    url: "https://www.mim.gov.it/documents/20182/0/Linee+guida+Comma16+finale.pdf/"
    year: 2017
  - title: "Report Effetto Farfalla — Discriminazione studenti LGBT a scuola (Gay Center)"
    url: "https://gaycenter.it/report-effetto-farfalla/"
    year: 2023
  - title: "Regolamento scolastico per la carriera alias (GenderLens)"
    ...
    year: 2024
  - title: "School Climate, Absenteeism and School Transfer Due to Transphobic Bullying in Transgender and Non-Binary Youth (PMC)"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12894489/"
    year: 2024
  - title: "Supporting Transgender and Gender Diverse Students in Schools (APA Division 16)"
    url: "https://www.apa.org/pi/lgbt/programs/safe-supportive/lgbt/school-administrators.pdf"
    year: 2020
  - title: "The LGBTQI Inclusion Index (UNESCO)"
    url: "https://www.unesco.org/en/articles/lgbtqi-inclusion-index-new-tool-measure-if-learning-environments-are-safe-non-violent-and-inclusive"
    year: 2023
  - title: "The Trevor Project: 2022 National Survey on LGBTQ Youth Mental Health"
    url: "https://www.thetrevorproject.org/survey-2022/"
    year: 2022
faq:
  - question: "Cos'è la carriera alias a scuola?"
    answer: "La carriera alias è un accordo di riservatezza tra scuola, studente e famiglia (se minorenne) che consente allo studente transgender di essere chiamato con il nome scelto nei registri interni, nelle comunicazioni e nelle email, prima della rettifica anagrafica ufficiale. In Italia oltre 480 scuole la prevedono."
  - question: "Cosa può fare un insegnante per supportare uno studente trans?"
    answer: "Usare il nome e i pronomi richiesti, intervenire contro il bullismo transfobico, non rivelare l'identità dello studente senza il suo consenso (outing), promuovere un linguaggio inclusivo in classe e formarsi sulle tematiche di genere."
  - question: "Esistono leggi che proteggono gli studenti trans nelle scuole italiane?"
    answer: "Non esiste una legge specifica per gli studenti transgender. Tuttavia, la Legge 107/2015 prevede l'educazione al rispetto e il contrasto a ogni forma di discriminazione. La Costituzione e lo Statuto delle studentesse e degli studenti tutelano il diritto allo studio e alla dignità."
  - question: "Mio figlio trans viene bullizzato a scuola: cosa posso fare?"
    answer: "Documentate gli episodi, chiedete un incontro con il dirigente scolastico, coinvolgete lo psicologo scolastico e, se necessario, segnalate la situazione all'UNAR (Ufficio Nazionale Antidiscriminazioni Razziali) o all'OSCAD (Osservatorio per la Sicurezza Contro gli Atti Discriminatori). Il Gay Help Line (800 713 713) offre supporto gratuito."
related:
...
L'indagine EU LGBTIQ Survey III dell'Agenzia dell'Unione Europea per i Diritti Fondamentali (FRA), pubblicata nel 2024, ha raccolto le esperienze di oltre 100.000 persone LGBTIQ in tutta Europa. I risultati per l'ambito scolastico sono pesanti: il 67% delle persone LGBTIQ ha dichiarato di aver subito bullismo, derisione, insulti o minacce durante gli anni di scuola. Tra i giovani di 15-17 anni, il 51% ha indicato che l'episodio di molestia più recente era stato perpetrato da qualcuno dell'ambiente scolastico.

Le persone transgender subiscono i tassi più elevati di discriminazione in assoluto: il 64% delle donne trans ha riportato di aver subito discriminazione nei dodici mesi precedenti l'indagine.

### Le conseguenze

Il bullismo transfobico non è un problema che si risolve "facendo la pelle dura". Le conseguenze documentate includono:

- **Abbandono scolastico e assenteismo.** Uno studio pubblicato su PMC nel 2024 ha dimostrato una correlazione diretta tra bullismo transfobico e aumento dell'assenteismo, con un numero significativo di studenti trans che cambiano scuola o abbandonano del tutto gli studi.
- **Disagio psicologico.** Il 26% delle vittime di bullismo omotransfobico sviluppa comportamenti autolesivi e il 15% manifesta pensieri suicidari, secondo i dati italiani.
...
Secondo l'indagine del Trevor Project del 2022, condotta su quasi 34.000 giovani LGBTQ negli Stati Uniti, i giovani trans che percepivano la propria scuola come un ambiente accogliente avevano tassi significativamente inferiori di tentativi di suicidio. L'ambiente scolastico non è un dettaglio: è un fattore determinante.
...
La diffusione della carriera alias nelle scuole italiane è cresciuta in modo significativo negli ultimi anni. Secondo i dati di AGEDO (Associazione di Genitori, Parenti e Amici di persone LGBT+), oltre 480 scuole in Italia prevedono nel proprio regolamento la carriera alias -- di cui 475 pubbliche e 6 paritarie. La Lombardia guida la classifica con 63 istituti, seguita da altre regioni del nord e del centro.

Nelle università la situazione è più consolidata. La prima università ad attivare la carriera alias fu quella di Torino nel 2003. Oggi quasi tutti i principali atenei italiani la prevedono, inclusi Bocconi, Bicocca, Cattolica, Statale e Politecnico a Milano, oltre a decine di altri in tutta Italia.
...
In attuazione di questa norma, il MIUR ha emanato nel 2017 le Linee Guida Nazionali "Educare al rispetto", che contengono indicazioni per il contrasto alle discriminazioni e la promozione di una cultura del rispetto. Le linee guida non menzionano esplicitamente gli studenti transgender, ma il riferimento al contrasto di "tutte le discriminazioni" è stato interpretato in modo estensivo da molte scuole.
...
- **Formarsi.** Non è necessario essere esperti di identità di genere per essere un buon insegnante per uno studente trans. Ma informarsi -- leggendo, partecipando a corsi di aggiornamento, consultando risorse come Infotrans.it -- è un gesto di responsabilità professionale.
...
Secondo GLSEN, il 68% degli studenti transgender dichiara di non avere accesso ai bagni coerenti con la propria identità di genere. Quando gli studenti sono costretti a usare i bagni del genere assegnato alla nascita, le conseguenze documentate includono: aumento del bullismo (i bagni sono uno degli spazi meno sorvegliati della scuola), sviluppo di problemi urinari (molti studenti evitano di andare in bagno per l'intera giornata scolastica) e aumento dell'assenteismo.
...
Non tutti gli psicologi scolastici hanno competenze specifiche sull'identità di genere. Uno psicologo che considera l'identità trans come un problema da risolvere, anziché come una parte della persona da accompagnare, può fare più danni che bene. Le linee guida dell'American Psychological Association (APA) raccomandano un approccio affermativo: lo psicologo non deve cercare di modificare l'identità di genere dello studente, ma supportarne il benessere complessivo.

Se lo psicologo scolastico non ha le competenze necessarie, è opportuno coinvolgere un professionista esterno specializzato. I centri ONIG (Osservatorio Nazionale sull'Identità di Genere) e il portale Infotrans.it offrono mappe dei servizi specializzati sul territorio.
...
- **Proponete la carriera alias** se non è già prevista nel regolamento scolastico. Portate il modello di regolamento di GenderLens come riferimento.
...
Secondo la ricerca di GLSEN, le scuole con politiche inclusive esplicite -- regolamenti anti-bullismo che menzionano l'identità di genere, formazione del personale, presenza di gruppi studenteschi di supporto -- registrano tassi significativamente inferiori di molestie verso gli studenti trans. Non si tratta di opinioni: è l'effetto misurabile di politiche concrete.

L'UNESCO ha sviluppato un LGBTQI Inclusion Index per misurare il grado di inclusione degli ambienti educativi. I fattori chiave identificati includono: legislazione anti-discriminazione che menzioni esplicitamente l'identità di genere, formazione obbligatoria per gli insegnanti, curricoli che includano la diversità di genere e meccanismi di segnalazione accessibili e sicuri.

### Le raccomandazioni dell'APA per le scuole

Le linee guida dell'American Psychological Association per il supporto degli studenti transgender nelle scuole raccomandano:
...
- **Infotrans.it** -- Il primo portale istituzionale europeo dedicato alle persone transgender, sviluppato dall'Istituto Superiore di Sanità in collaborazione con l'UNAR. Contiene schede informative sulla discriminazione, sui percorsi e una mappa dei servizi sul territorio. Sito: [infotrans.it](https://www.infotrans.it/)
- **UNAR** (Ufficio Nazionale Antidiscriminazioni Razziali) -- Riceve segnalazioni di discriminazione anche in ambito scolastico, anche in forma anonima. Sito: [unar.it](https://www.unar.it/)
- **OSCAD** (Osservatorio per la Sicurezza Contro gli Atti Discriminatori) -- Attivo dal 2011, supporta le persone appartenenti a minoranze nel concreto godimento del diritto alla parità e alla protezione dalla discriminazione. Sito: [interno.gov.it/OSCAD](https://www.interno.gov.it/it/ministero/osservatori/osservatorio-sicurezza-contro-atti-discriminatori-oscad)

### Associazioni

- **AGEDO** -- Associazione di genitori, parenti e amici di persone LGBT+, con sedi in tutta Italia. Offre gruppi di ascolto, supporto tra pari, accompagnamento e un elenco aggiornato delle scuole con carriera alias. Sito: [agedonazionale.org](https://www.agedonazionale.org/)
- **GenderLens** -- Associazione di genitori con risorse specifiche per famiglie di minori trans. Offre un modello di regolamento scolastico per la carriera alias, consulenze e formazione nelle scuole. Sito: [genderlens.org](https://www.genderlens.org/)
- **Arcigay** -- La più grande associazione LGBT+ italiana, con sezioni locali che offrono supporto, consulenza e interventi nelle scuole. Sito: [arcigay.it](https://www.arcigay.it/)
...
La scuola italiana non è pronta, ma non è nemmeno ferma. In pochi anni, il numero di istituti con la carriera alias è passato da poche decine a oltre 480. Le associazioni di genitori hanno creato reti di supporto che dieci anni fa non esistevano. Sempre più insegnanti si formano, sempre più dirigenti scolastici si rendono disponibili, sempre più studenti trovano il coraggio di essere se stessi.
