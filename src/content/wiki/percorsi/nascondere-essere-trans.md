...
sources:
  - title: "Gazzetta Ufficiale - Legge 14 aprile 1982, n. 164"
    ...
    year: 1982
  - title: "Regolamento UE 2016/679 (GDPR) - Articolo 9: Trattamento di categorie particolari di dati personali"
    url: "https://www.privacy-regulation.eu/it/9.htm"
    year: 2016
  - title: "Art. 622 codice penale - Rivelazione di segreto professionale"
    url: "https://www.brocardi.it/codice-penale/libro-secondo/titolo-xii/capo-iii/sezione-v/art622.html"
    year: 1930
  - title: "Art. 167 codice della privacy - Trattamento illecito di dati (D.lgs. 196/2003)"
    url: "https://www.brocardi.it/codice-della-privacy/parte-iii/titolo-iii/capo-ii/art167.html"
    year: 2003
  - title: "Corte costituzionale - Sentenza n. 221 del 2015"
    ...
    year: 2015
  - title: "CEDU - Scheda tematica: Gender identity issues"
    url: "https://www.echr.coe.int/documents/d/echr/fs_gender_identity_eng"
    year: 2024
  - title: "Agenda Digitale - Privacy e identità di genere: come gestire i dati sensibili in linea col GDPR"
    ...
    year: 2023
  - title: "La Legge per Tutti - Nascondere al proprio partner di essere trans è reato?"
    url: "https://www.laleggepertutti.it/499126_nascondere-al-proprio-partner-di-essere-trans-e-reato"
    year: 2023
  - title: "D.lgs. 9 luglio 2003, n. 216 - Discriminazione sul lavoro"
    url: "https://www.lavoro.gov.it/_layouts/Lavoro.Web/AppPages/GetResource?ds=oil&rid=1029"
    year: 2003
  - title: "Garante per la Protezione dei Dati Personali - Cosa intendiamo per dati personali"
    url: "https://www.garanteprivacy.it/home/diritti/cosa-intendiamo-per-dati-personali"
    year: 2024
  - title: "Corte EDU - S.V. c. Italia: transizione di genere e art. 8 CEDU"
    url: "https://www.biodiritto.org/Biolaw-pedia/Giurisprudenza/Corte-Europea-dei-Diritti-dell-Uomo-S.V.-c.-Italia-transizione-di-genere"
    year: 2018
  - title: "UK Gender Recognition Act 2004 - Protected information provisions"
    url: "https://en.wikipedia.org/wiki/Gender_Recognition_Act_2004"
    year: 2004
faq:
  - question: "Nascondere di essere trans è reato?"
    answer: "No. In Italia non esiste alcun obbligo legale di rivelare di essere transgender. L'identità di genere è protetta dalla normativa sulla privacy (GDPR) come dato personale sensibile."
  - question: "Devo dire al mio partner che sono trans?"
    answer: "Non esiste un obbligo legale. La disclosure è una scelta personale che dipende dal contesto e dalla sicurezza. Nessun tribunale italiano ha mai condannato una persona trans per non aver rivelato la propria storia medica."
  - question: "Il datore di lavoro può chiedermi se sono trans?"
    answer: "No. Il datore di lavoro non ha diritto di conoscere la storia medica o l'identità di genere precedente di un dipendente. Dopo la rettificazione anagrafica, i documenti riflettono il genere corretto."
  - question: "Un medico può rivelare che sono trans?"
    answer: "No. Il segreto professionale medico copre tutte le informazioni sanitarie, inclusa la storia di transizione. La violazione è un reato penale (art. 622 c.p.)."
related:
  - privacy-identita-di-genere
  - legge-164-italia
...
Il diritto alla riservatezza sulla propria identità di genere si fonda su basi costituzionali solide. L'**articolo 2 della Costituzione** riconosce e garantisce i diritti inviolabili della persona, sia come singolo sia nelle formazioni sociali in cui si svolge la sua personalità. La **Corte Costituzionale**, a partire dalla sentenza n. 161/1985, ha stabilito che il diritto all'[identità di genere](/wiki/identita-di-genere) rientra nel più ampio diritto alla realizzazione della propria personalità tutelato da questo articolo.
...
La **[Legge n. 164 del 1982](/wiki/legge-164-italia)**, che disciplina la rettificazione di attribuzione di sesso, contiene un principio fondamentale spesso sottovalutato. L'articolo 5 (originariamente articolo 4) stabilisce che i certificati di stato civile relativi a una persona la cui attribuzione di sesso sia stata rettificata per via giudiziaria devono essere rilasciati con la sola indicazione del **nuovo sesso e del nuovo nome**. Questo significa che il legislatore, già nel 1982, ha inteso proteggere la riservatezza delle persone trans: dopo la rettificazione anagrafica, nessun documento ufficiale deve rivelare il genere precedente.
...
Tutte le informazioni relative alla storia di transizione di una persona -- diagnosi, terapie ormonali, interventi chirurgici, supporto psicologico -- sono coperte dal segreto professionale. Un medico, uno psicologo, un infermiere, un farmacista che rivelasse a terzi la condizione transgender di un paziente senza il suo consenso commetterebbe un **reato penale**.
...
Le eccezioni al segreto professionale sono tassative e non comprendono la curiosità di terzi sull'identità di genere di un paziente. Il medico può derogare al segreto solo in presenza di una "giusta causa", come l'obbligo di referto per reati procedibili d'ufficio, la tutela di un interesse vitale superiore, o specifici obblighi di legge. La semplice richiesta di un familiare, un datore di lavoro o un partner di sapere se una persona è transgender **non costituisce giusta causa**.

## Tutele nel contesto lavorativo

### Cosa non può chiedere il datore di lavoro

Il **D.lgs. 216/2003**, che attua la Direttiva europea 2000/78/CE, vieta le discriminazioni nell'ambito del lavoro fondate, tra l'altro, sull'orientamento sessuale. La giurisprudenza italiana ha esteso queste tutele anche alle persone transgender, ricondotta alla discriminazione fondata sul sesso. A livello europeo, la **Direttiva 2006/54/CE** (Gender Recast Directive) include esplicitamente un riferimento alla discriminazione basata sulla riassegnazione di genere.

In questo quadro normativo, il datore di lavoro **non ha alcun diritto** di conoscere la storia medica o l'identità di genere precedente di un dipendente. In sede di colloquio, domande sull'identità di genere, sulla storia di transizione o sullo stato dei documenti anagrafici sono illegittime. Dopo la rettificazione anagrafica, tutti i documenti -- contratto di lavoro, busta paga, badge identificativo -- devono riportare il nome e il genere corretti. Ma anche prima della rettificazione, il datore di lavoro non è legittimato a indagare sull'identità di genere del dipendente.

### Outing sul luogo di lavoro

Se un collega o un superiore rivela senza consenso la condizione transgender di un lavoratore, la condotta può configurare diverse fattispecie illecite: violazione della normativa sulla [privacy](/wiki/privacy-identita-di-genere) (GDPR e D.lgs. 196/2003), mobbing (se la condotta è reiterata e sistematica), diffamazione (art. 595 c.p., se avviene in presenza di più persone e lede la reputazione), e discriminazione ai sensi del D.lgs. 216/2003. Il lavoratore che subisce outing sul posto di lavoro ha diritto a rivolgersi al Garante per la Privacy, a presentare una denuncia per discriminazione e, nei casi più gravi, ad agire per il risarcimento del danno.
...
L'**articolo 8 della Convenzione Europea dei Diritti dell'Uomo** (CEDU) sancisce il diritto al rispetto della vita privata e familiare. La **Corte Europea dei Diritti dell'Uomo** ha costruito, attraverso decenni di giurisprudenza, un quadro di protezione solido per le persone transgender che ha implicazioni dirette sulla questione della disclosure.

Nella sentenza **Christine Goodwin c. Regno Unito** (2002), la Grande Camera ha riconosciuto senza ambiguità che l'identità di genere costituisce un aspetto essenziale dell'identità intima della persona, protetto dall'articolo 8. Nella sentenza **S.V. c. Italia** (2018), la Corte ha condannato l'Italia per aver negato a una donna transgender la possibilità di modificare il proprio nome in assenza di un accertamento giudiziario del "pieno cambio di sesso", stabilendo che questa limitazione violava il diritto al rispetto della vita privata.

### Implicazioni per la disclosure

La giurisprudenza della Corte di Strasburgo ha progressivamente riconosciuto che il mancato riconoscimento dell'identità di genere, e dunque l'esposizione forzata della storia di transizione, costituisce una violazione dell'articolo 8. Il principio è chiaro: se l'identità di genere rientra nella sfera più intima della vita privata, nessuno può essere obbligato a rivelarla.

La scheda tematica della CEDU sulle questioni di identità di genere conferma questa evoluzione: la Corte si muove verso il riconoscimento del diritto alla modifica del genere legale su base incondizionata, rafforzando il principio secondo cui la storia di transizione appartiene alla sfera privata della persona e non è soggetta a obblighi di disclosure.
...
Questo caso evidenzia una differenza significativa rispetto all'Italia: nel nostro ordinamento, nessuna giurisprudenza analoga è mai stata stabilita.
...
A livello globale, nessun ordinamento democratico prevede un obbligo generalizzato di rivelare la propria identità di genere. La tendenza internazionale, documentata dalla giurisprudenza della CEDU e dalle legislazioni più recenti, è nella direzione opposta: proteggere il diritto delle persone trans a non essere esposte senza il proprio consenso.
...
- **Non esiste un obbligo legale di rivelare di essere transgender** in Italia, né nei rapporti personali, né in quelli lavorativi, né in quelli sessuali.
- L'identità di genere è un **dato sensibile** protetto dal GDPR (art. 9) e dalla normativa italiana sulla privacy.
- Chi rivela senza consenso l'identità di genere di un'altra persona può incorrere in **sanzioni penali e amministrative** (art. 167 D.lgs. 196/2003, artt. 83-84 GDPR).
- Il **segreto professionale medico** copre tutte le informazioni relative alla transizione (art. 622 c.p.).
- Il datore di lavoro **non può chiedere** informazioni sull'identità di genere precedente di un dipendente.
- Dopo la rettificazione anagrafica, i documenti riportano **solo il nuovo nome e genere** (Legge 164/1982, art. 5).
- La **CEDU** protegge l'identità di genere come elemento della vita privata (art. 8 Convenzione).
