---
title: "Mio figlio dice di essere trans: guida per genitori"
seoTitle: "Mio figlio dice di essere trans: cosa fare? Guida per genitori"
slug: "mio-figlio-trans"
description: "Guida completa per genitori che hanno appena saputo che il loro figlio o la loro figlia è transgender: cosa fare, dove andare, cosa dice la scienza. Con dati reali e risorse italiane."
category: "percorsi"
tags: ["mio figlio trans", "figlio transgender", "genitori figli trans", "cosa fare figlio trans", "mio figlio vuole cambiare sesso", "mia figlia si sente maschio", "supporto genitori trans", "bambino transgender", "disforia genere minori", "percorso clinico trans Italia"]
date: "2026-03-03"
updated: "2026-03-03"
...
sources:
  ...
  - title: "Standards of Care for the Health of Transgender and Gender Diverse People, Version 8 (WPATH)"
    ...
    year: 2022
faq:
  - question: "Mio figlio dice di essere trans: è solo una fase?"
    answer: "Nei bambini che hanno già fatto una transizione sociale, gli studi mostrano che il 94-97% mantiene la propria identità anche cinque anni dopo. Più l'identità è espressa in modo persistente, consistente e insistente, meno probabile è che sia transitoria. Un professionista esperto può aiutare a capire la situazione specifica."
  - question: "Cosa devo fare subito dopo che mio figlio mi ha detto di essere trans?"
    answer: "La cosa più importante è non reagire con rifiuto. Anche se sei confuso o spaventato, digli che lo ami. Non devi capire tutto subito. Ascolta, fai domande aperte, e prenditi il tempo necessario senza minimizzare o negare ciò che ha condiviso con te."
  - question: "A chi mi rivolgo in Italia per mio figlio trans?"
    answer: "In Italia esistono centri specializzati nel SSN in diverse città (Roma, Torino, Firenze, Bologna, Milano, Napoli). Puoi anche contattare AGEDO o GenderLens per supporto immediato ai genitori. Il pediatra o il medico di base può fare il primo riferimento."
  - question: "Devo usare il nome e i pronomi che ha scelto mio figlio?"
    answer: "La ricerca mostra che usare il nome scelto riduce del 71% i sintomi di depressione grave e del 65% i tentativi di suicidio nei giovani trans (Russell et al., 2018). Non è solo una questione di rispetto: è un atto con effetti misurabili sulla salute mentale di tuo figlio."
  - question: "I bloccanti della pubertà sono sicuri?"
    answer: "Gli agonisti del GnRH usati come bloccanti della pubertà sono impiegati da oltre 40 anni in pediatria per la pubertà precoce. Sono reversibili: alla sospensione, la pubertà riprende. Le principali società scientifiche internazionali (WPATH, Endocrine Society, AAP) li considerano un'opzione appropriata sotto supervisione medica specialistica."
related:
  - sono-trans
...
Quando un ragazzo o una ragazza dichiara di essere **transgender**, sta dicendo che la propria [identità di genere](/wiki/identita-di-genere) -- la percezione profonda e interiore di sé come maschio, femmina, o altro -- non corrisponde al sesso assegnato alla nascita.
...
- **[Transizione sociale](/wiki/transizione-sociale)**: cambiare nome, pronomi, abbigliamento e modo di presentarsi nella vita quotidiana, senza interventi medici.
...
Se il percorso psicologico conferma la presenza di incongruenza di genere e il minore si trova alle soglie della pubertà (stadi Tanner 2-3), il centro può proporre l'uso di **analoghi del GnRH** (comunemente chiamati [bloccanti della pubertà](/wiki/bloccanti-puberta)). Questi farmaci sospendono temporaneamente lo sviluppo puberale, dando al giovane e alla famiglia il tempo di esplorare le opzioni senza che il corpo cambi in modo difficilmente reversibile.
...
Se tuo figlio frequenta la scuola, potresti valutare di richiedere la **[carriera alias](/wiki/carriera-alias)**: un accordo con l'istituto che permette di usare il nome scelto nel registro e nelle comunicazioni interne, senza modificare i documenti legali. Oltre 500 scuole italiane l'hanno adottata. Per i minorenni serve il consenso di almeno un genitore.
...
**Mio figlio è trans perché l'ha visto sui social?**
La ricerca non supporta l'idea che l'esposizione ai social media "crei" identità trans. Lo studio di Littman (2018) che ipotizzava un "contagio sociale" è stato ampiamente criticato per gravi problemi metodologici ed è stato parzialmente ritrattato. Ciò che i social fanno, semmai, è dare ai giovani trans il linguaggio per descrivere qualcosa che hanno sempre vissuto -- e spesso la connessione con comunità di pari che capiscono. Per approfondire, vedi l'articolo sul [contagio sociale](/wiki/contagio-sociale-trans).

**E se mio figlio si sbaglia e poi se ne pente?**
La detransizione esiste ed è un'esperienza reale. Le statistiche attuali la stimano tra il 2% e l'8% circa, con cause che includono pressioni sociali e familiari più spesso delle rivalutazioni dell'identità. Il percorso clinico italiano è pensato proprio per prendersi il tempo necessario: la valutazione psicologica di 6-12 mesi, la reversibilità dei bloccanti, i passi graduali, servono esattamente a questo. Per saperne di più: [detransizione](/wiki/detransizione).

**Posso oppormi al percorso medico?**
In Italia, per qualsiasi intervento medico su un minore è necessario il consenso di entrambi i genitori (o del genitore affidatario). Questo significa che hai voce in capitolo. Detto ciò, opporti al supporto non impedisce la sofferenza di tuo figlio: la posticipa, e spesso la intensifica. La conversazione con un professionista -- per te, per lui, per voi insieme -- è sempre il passo più utile.

**Come ne parlo con gli altri figli?**
I fratelli e le sorelle spesso si adattano più velocemente degli adulti. Puoi dirlo con semplicità: "Il tuo fratello/la tua sorella si sente davvero una ragazza/un ragazzo, e noi vogliamo che stia bene". Rispondere alle domande con onestà e calma è più efficace di qualsiasi spiegazione elaborata. Se i fratelli faticano, anche per loro è disponibile supporto psicologico.

**Mio figlio è trans e gay allo stesso tempo?**
